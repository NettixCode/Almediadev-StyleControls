  ...
  begin
    ...
    try
      ...
      case APart of
        ...
        sbpLineDown:
          if AHorizontal then
            scDrawUtils.DrawRightScrollButton(TcxCanvas(ACanvas).Canvas, R, scGetState(AState))
          else
            scDrawUtils.DrawDownScrollButton(TcxCanvas(ACanvas).Canvas, R, scGetState(AState));

        sbpLineUp:
          if AHorizontal then
            scDrawUtils.DrawLeftScrollButton(TcxCanvas(ACanvas).Canvas, R, scGetState(AState))
          else
            scDrawUtils.DrawUpScrollButton(TcxCanvas(ACanvas).Canvas, R, scGetState(AState));
        ...
        sbpThumbnail:
          if AHorizontal then
            scDrawUtils.DrawHScrollThumb(TcxCanvas(ACanvas).Canvas, R, scGetState(AState))
          else
            scDrawUtils.DrawVScrollThumb(TcxCanvas(ACanvas).Canvas, R, scGetState(AState));
      end;
