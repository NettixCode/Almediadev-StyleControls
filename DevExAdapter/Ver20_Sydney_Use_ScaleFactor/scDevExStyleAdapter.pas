...
begin
  ...
  {$ENDIF}
   case ACheckState of
    cbsChecked:  scDrawUtils.DrawCheckBox(ACanvas.Canvas, R, scGetState(AState), cbChecked{$IFDEF VER340_UP}, LScaleFactor{$ENDIF});
    cbsUnChecked: scDrawUtils.DrawCheckBox(ACanvas.Canvas, R, scGetState(AState), cbUnChecked{$IFDEF VER340_UP}, LScaleFactor{$ENDIF});
    cbsGrayed: scDrawUtils.DrawCheckBox(ACanvas.Canvas, R, scGetState(AState), cbUnChecked{$IFDEF VER340_UP}, LScaleFactor{$ENDIF});
  end;
end;
