...
var
  C: TColor;
begin
  C := scDrawUtils.GetStyleColor(clBtnText{$IFDEF VER340_UP}, Self{$ENDIF});
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        InflateRect(Rct, -1, -1);
        FillRect(Rct);
        C :=  scDrawUtils.GetStyleColor(clBtnShadow{$IFDEF VER340_UP}, Self{$ENDIF});
...
begin
  ...
  scsiArrows:
   begin
     ACanvas.Brush.Color := scDrawUtils.GetStyleColor(clBtnText{$IFDEF VER340_UP}, Self{$ENDIF});
     ACanvas.Pen.Color := scDrawUtils.GetStyleColor(clBtnText{$IFDEF VER340_UP}, Self{$ENDIF});
