...
interface
  ...
  TscMargins = SC_MARGINS;
   ...
   published
     ...
     property PressedAlphaValue: Byte read FPressedAlphaValue write SetPressedAlphaValue;
  ...
  function Windows10Build: Integer;
  // style
  function IsWindowsModernStyle{$IFDEF VER340_UP}(AControl: TControl = nil){$ENDIF}: Boolean;
  function IsDarkStyle{$IFDEF VER340_UP}(AControl: TControl = nil){$ENDIF}: Boolean;
  function IsDarkWindowStyle{$IFDEF VER340_UP}(AControl: TControl = nil){$ENDIF}: Boolean;
  function IsCustomStyle{$IFDEF VER340_UP}(AControl: TControl = nil){$ENDIF}: Boolean;
  // draw controls
  procedure DrawBorder(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawEditBorder(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawComboBoxBorder(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawSingleBorder(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawPushButtonComboBox(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; ADrawFocusRect: Boolean; AScaleDrawFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; ADrawFocusRect: Boolean; AScaleDrawFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawSegmentedButton(ACanvas: TCanvas; ARect: TRect;
    ACtrlState: TscsCtrlState; ADrawFocusRect: Boolean; ADrawCode: Integer; AScaleDrawFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawSegmentedToolButton(ACanvas: TCanvas; ARect: TRect;
    ACtrlState: TscsCtrlState; ADrawCode: Integer; AScaleDrawFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawSplitButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState;
     ADroppedDown: Boolean; AChevronWidth: Integer{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawSplitToolButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState;
    ADroppedDown: Boolean; AChevronWidth: Integer{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawToolButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawToolButton2(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawUpSpinButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawDownSpinButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawLeftSpinButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawRightSpinButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  function GetCheckBoxSize(ACanvas: TCanvas; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): Integer;
  procedure DrawTreeCheckBox(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; ACheckBoxState: TCheckBoxState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawCheckBox(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; ACheckBoxState: TCheckBoxState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawCheckBoxInCenter(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; ACheckBoxState: TCheckBoxState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawRadioButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; ACheckBoxState: TCheckBoxState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawDropDownButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; ANewStyle: Boolean; ARightToLeft: Boolean; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawGroupBoxFrame(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawHeaderSection(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawCategoryHeader(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawSelection(ACanvas: TCanvas; ARect: TRect; AFocused, AFocusedSelection: Boolean{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawSelectionWithAlpha(ACanvas: TCanvas; ARect: TRect; AAlpha: Integer{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure FillRectWithAlpha(ACanvas: TCanvas; ARect: TRect; AAlpha: Integer);
  procedure DrawToolBar(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawTab(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState;
    ATabPosition: TTabPosition; AFirst, ALast: Boolean{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawSimpleTab(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawTabFrame(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawPopupWindow(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawPopupSelectionWithAlpha(ACanvas: TCanvas; ARect: TRect; AAlpha: Integer{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawTabWithAlpha(ACanvas: TCanvas; ARect: TRect; AAlpha: Integer{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawPopupItem(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawFormBackground(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawProgressBar(ACanvas: TCanvas; ARect: TRect; AMin, AMax, AValue: Integer{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawProgressBarBorder(ACanvas: TCanvas; ARect: TRect; AVertical: Boolean{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawProgressBarChunk(ACanvas: TCanvas; ARect: TRect; AVertical: Boolean{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawTrackBarTrack(ACanvas: TCanvas; ARect: TRect; AVertical: Boolean{$IFDEF VER340_UP}; AScaleFactor: Double = 1; AControl: TControl = nil{$ENDIF});
  procedure DrawTrackBarThumb(ACanvas: TCanvas; ARect: TRect; AVertical: Boolean; ACtrlState: TscsCtrlState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawStatusPanel(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawStatusBar(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawHorzSplitter(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawVertSplitter(ACanvas: TCanvas; ARect: TRect; AIsRightToLeft: Boolean = False{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});

  // scroll bar
  procedure DrawUpScrollButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawDownScrollButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawLeftScrollButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawRightScrollButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawHScrollThumb(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawHScrollFrame(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawVScrollThumb(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawVScrollFrame(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  // get text colors
  function GetActiveTextColor{$IFDEF VER340_UP}(AControl: TControl = nil){$ENDIF}: TColor;
  function GetEditTextColor(ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  function GetEditBrushColor(ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  function GetButtonTextColor(ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  function GetToolButtonTextColor(ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  function GetCheckBoxTextColor(ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  function GetRadioButtonTextColor(ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  function GetGroupBoxTextColor(ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  function GetHeaderTextColor(ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  function GetCategoryHeaderTextColor{$IFDEF VER340_UP}(AControl: TControl = nil){$ENDIF}: TColor;
  function GetStyleColor(AColor: TColor {$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  function GetSelectionTextColor{$IFDEF VER340_UP}(AControl: TControl = nil){$ENDIF}: TColor;
  function GetTabTextColor(ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  function GetSimpleTabTextColor(ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  function GetPopupItemTextColor(ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  function GetCaptionTextColor(ACtrlState: TscsCtrlState{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): TColor;
  // draw text and image
  ...
  procedure DrawTextAlignmentNoPrefix(ACanvas: TCanvas; AText: String; ARect: TRect; AAlignment: TAlignment; ARightToLeft: Boolean; AShowEllipsis: Boolean = False);
  procedure DrawTextAlignmentNoPrefixMultiLine(ACanvas: TCanvas; AText: String; ARect: TRect; AAlignment: TAlignment; ARightToLeft: Boolean);
  ...
  procedure DrawImageAndText2(ACanvas: TCanvas; ARect: TRect; AMargin, ASpacing: Integer;
            ...
            AText: String; AImageIndex: Integer; AImageList: TCustomImageList;
            AEnabled: Boolean; ADrawColorMarker: Boolean; AColorMarkerValue: TColor; ADrawFocusRect: Boolean;
            ARightToLeft: Boolean; ANoPrefix: Boolean; AScaleDrawFactor: Double = 1; AWordWrap: Boolean = True; AEndEllipsis: Boolean = False);
  ...
  procedure DrawImageAndTextWithGlow2(ACanvas: TCanvas; ARect: TRect; AMargin, ASpacing: Integer;
            ...
            ADrawFocusRect: Boolean;
            ARightToLeft: Boolean;
            ANoPrefix: Boolean; AScaleDrawFactor: Double = 1; AWordWrap: Boolean = True; AEndEllipsis: Boolean = False);
  ...
  procedure DrawComboArrowImage(ACanvas: TCanvas; ARect: TRect; AColor: TColor; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  ...
  procedure DrawTreeExpandImage(ACanvas: TCanvas; ARect: TRect; AExpanded: Boolean; ABorderColor: TColor; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  ...
  function IsLightColor(AColor: TColor{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF}): Boolean;
  ...
  procedure scPasteText(AEdit: TCustomEdit; const AText: string);

  function SC_DwmCompositionEnabled: Boolean;

  function SC_GetUniqueName(const Name: string; const AComponent: TComponent): string;
  ...
  const
     ...
     SC_DWM_WCP_DEFAULT = 0;
     SC_DWM_WCP_DONOTROUND = 1;
     SC_DWM_WA_WINDOW_CORNER_PREFERENCE = 33;
...
implementation
 ...
 var
   FOSMajor, FOSMinor, FWindows10Build: Integer;
...
begin
  ...
  if (FColor = clHighLight) and (Result > 170) and
     not IsCustomStyle{$IFDEF VER340_UP}(FControl){$ENDIF} and not StyleServices{$IFDEF VER340_UP}(FControl){$ENDIF}.Enabled then
    Result := Result - 80;
end;
...
procedure GetWindows10BuildNumber(var Build: Integer);
var
  VerInfo: TOSVersionInfoEx;
begin
  if IsWindows10 then
  begin
    Build := TOSVersion.Build;
    if Build = 0 then
    begin
...
function IsWindows11: Boolean;
begin
  Result := (FOSMajor >= 10) and (Windows10Build >= 22000);
end;
...
var
  ...
  FColor: TColor;
begin
  FColor := GetStyleColor(AColor{$IFDEF VER340_UP}, AControl{$ENDIF});
...
var
  ...
  FColor: TColor;
begin
  FColor := GetStyleColor(clBtnFace{$IFDEF VER340_UP}, AControl{$ENDIF});
  FColor := ColorToRGB(FColor);
  r := GetRValue(FColor);
  g := GetGValue(FColor);
  b := GetBValue(FColor);
...
var
  ...
  FColor: TColor;
begin
  FColor := GetStyleColor(clWindow{$IFDEF VER340_UP}, AControl{$ENDIF});
  FColor := ColorToRGB(FColor);
  r := GetRValue(FColor);
  g := GetGValue(FColor);
  b := GetBValue(FColor);
...
begin
  Result := False;
  if IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
  begin
    {$IFDEF VER340_UP}
    if AControl <> nil then
    begin
      S := AControl.GetStyleName;
      if S <> '' then
        Result := Pos('windows', LowerCase(S)) <> 0
    end
    else
    {$ENDIF}
...
begin
  {$IFDEF VER340_UP}
  if AControl <> nil then
    Result :=  {$IFNDEF VER350_UP} not (csDesigning in AControl.ComponentState) and {$ENDIF}AControl.IsCustomStyleActive
  else
  {$ENDIF}
...
begin
  if AScaleFactor < 1 then AScaleFactor := 1;
  ACanvas.Pen.Color := AColor;
  if (IsWindows10 and not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF}) or (IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} and (IsWindowsModernStyle{$IFDEF VER340_UP}(AControl){$ENDIF} or SC_MODERNARROWS)) then
  begin
  ...
  if IsWindows8 and not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
  begin
    X := ARect.Left + ARect.Width div 2;
    Y := ARect.Top + ARect.Height div 2 + Round(2 * AScaleFactor) - 1;
    Offset := Round(4 * AScaleFactor);
...
begin
  ...
  LStyle := StyleServices{$IFDEF VER340_UP}(AControl){$ENDIF};
  if LStyle.Enabled then
  begin
    if not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
     case ACtrlState of
        scsNormal:
           Details := LStyle.GetElementDetails(tsUpNormal);
        scsHot, scsFocused:
           Details := LStyle.GetElementDetails(tsUpHot);
        scsPressed:
           Details := LStyle.GetElementDetails(tsUpPressed);
        scsDisabled:
          Details := LStyle.GetElementDetails(tsUpDisabled);
      end
    else
      case ACtrlState of
        scsNormal:
           Details := LStyle.GetElementDetails(tsArrowBtnUpNormal);
        scsHot, scsFocused:
           Details := LStyle.GetElementDetails(tsArrowBtnUpHot);
        scsPressed:
           Details := LStyle.GetElementDetails(tsArrowBtnUpPressed);
        scsDisabled:
          Details := LStyle.GetElementDetails(tsArrowBtnUpDisabled);
      end;
    LStyle.DrawElement(ACanvas.Handle, Details, ARect{$IFDEF VER330_UP},nil, FDPI{$ENDIF});
    if not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} and (ARect.Height <= 9) then
    begin
      R := ARect;
      R.Bottom := R.Top + 2;
      R1 := ARect;
      ...
      try
        ...
        LStyle.DrawElement(ACanvas.Handle, Details, R1{$IFDEF VER330_UP},nil, FDPI{$ENDIF});
      finally
        RestoreDC(ACanvas.Handle, SaveIndex);
      end;
    end;
...
begin
  ...
  begin
    if not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
      case ACtrlState of
        scsNormal:
           Details := LStyle.GetElementDetails(tsDownNormal);
        scsHot, scsFocused:
           Details := LStyle.GetElementDetails(tsDownHot);
        scsPressed:
           Details := LStyle.GetElementDetails(tsDownPressed);
        scsDisabled:
           Details := LStyle.GetElementDetails(tsDownDisabled);
       end
     else
      case ACtrlState of
        scsNormal:
           Details := LStyle.GetElementDetails(tsArrowBtnDownNormal);
        scsHot, scsFocused:
           Details := LStyle.GetElementDetails(tsArrowBtnDownHot);
        scsPressed:
           Details := LStyle.GetElementDetails(tsArrowBtnDownPressed);
        scsDisabled:
...
begin
  ...
  begin
    if not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
     case ACtrlState of
        scsNormal:
           Details := LStyle.GetElementDetails(tsUpHorzNormal);
        scsHot, scsFocused:
           Details := LStyle.GetElementDetails(tsUpHorzHot);
        scsPressed:
           Details := LStyle.GetElementDetails(tsUpHorzPressed);
        scsDisabled:
           Details := LStyle.GetElementDetails(tsUpHorzDisabled);
      end
    else
      case ACtrlState of
        scsNormal:
           Details := LStyle.GetElementDetails(tsArrowBtnRightNormal);
        scsHot, scsFocused:
           Details := LStyle.GetElementDetails(tsArrowBtnRightHot);
        scsPressed:
           Details := LStyle.GetElementDetails(tsArrowBtnRightPressed);
        scsDisabled:
...
begin
  ...
  begin
    if not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
      case ACtrlState of
        scsNormal:
           Details := LStyle.GetElementDetails(tsDownHorzNormal);
        scsHot, scsFocused:
           Details := LStyle.GetElementDetails(tsDownHorzHot);
        scsPressed:
           Details := LStyle.GetElementDetails(tsDownHorzPressed);
        scsDisabled:
          Details := LStyle.GetElementDetails(tsDownHorzDisabled);
      end
    else
      case ACtrlState of
        scsNormal:
           Details := LStyle.GetElementDetails(tsArrowBtnLeftNormal);
        scsHot, scsFocused:
           Details := LStyle.GetElementDetails(tsArrowBtnLeftHot);
        scsPressed:
           Details := LStyle.GetElementDetails(tsArrowBtnLeftPressed);
        scsDisabled:
...
begin
  ...
  begin
    ...
    LStyle.DrawElement(ACanvas.Handle, Details, R1);
    if LStyle.IsSystemStyle and ADrawFocusRect then
    begin
  ...
  begin
    ...
    if ADrawFocusRect and not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
    begin
      InflateRect(ARect, -3, -3);
      DrawFocusRect(ARect);
    end;
...
begin
  LStyle := StyleServices{$IFDEF VER340_UP}(AControl){$ENDIF};
  if IsWindows11 and LStyle.IsSystemStyle and LStyle.Enabled then
  begin
    case ACtrlState of
      scsNormal:
         Details := LStyle.GetElementDetails(tcReadOnlyNormal);
      scsHot:
         Details := LStyle.GetElementDetails(tcReadOnlyHot);
      scsPressed:
         Details := LStyle.GetElementDetails(tcReadOnlyPressed);
      scsFocused:
         Details := LStyle.GetElementDetails(tcReadOnlyHot);
      scsDisabled:
         Details := LStyle.GetElementDetails(tcReadOnlyDisabled);
    end;
    LStyle.DrawElement(ACanvas.Handle, Details, ARect);
    if LStyle.IsSystemStyle and ADrawFocusRect then
    begin
      InflateRect(ARect, -3, -3);
      if ADrawFocusRect then scDrawFocusRect(ACanvas, ARect, AScaleDrawFactor);
    ...
    DrawButton(ACanvas, ARect, ACtrlState, ADrawFocusRect, AScaleDrawFactor{$IFDEF VER340_UP}, AControl{$ENDIF});
end;

procedure DrawButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState;
  ADrawFocusRect: Boolean; AScaleDrawFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
var
  Details:  TThemedElementDetails;
  LStyle: TCustomStyleServices;
begin
...
begin
  ...
  if not ADroppedDown then
    DrawButton(ACanvas, ARect, ACtrlState, False{$IFDEF VER340_UP} ,1, AControl{$ENDIF})
  else
  begin
    SaveIndex := SaveDC(ACanvas.Handle);
    try
      IntersectClipRect(ACanvas.Handle, R.Left, R.Top, R.Right, R.Bottom);
      DrawButton(ACanvas, ARect, scsHot, False{$IFDEF VER340_UP} ,1, AControl{$ENDIF});
    finally
      RestoreDC(ACanvas.Handle, SaveIndex);
    end;
    SaveIndex := SaveDC(ACanvas.Handle);
    try
      ...
      DrawButton(ACanvas, ARect, scsPressed, False{$IFDEF VER340_UP} ,1, AControl{$ENDIF});
    finally
      RestoreDC(ACanvas.Handle, SaveIndex);
    end;
  end;
  Inc(CR.Top, 2);
  Dec(CR.Bottom, 2);
  DrawVertSplitter (ACanvas, CR{$IFDEF VER340_UP}, False, AControl{$ENDIF});
end;
...
begin
  ...
  CR.Left := CR.Right - AChevronWidth;
  if not ADroppedDown then
    DrawToolButton(ACanvas, ARect, ACtrlState{$IFDEF VER340_UP}, AControl{$ENDIF})
  else
  begin
    SaveIndex := SaveDC(ACanvas.Handle);
    try
      IntersectClipRect(ACanvas.Handle, R.Left, R.Top, R.Right, R.Bottom);
      DrawToolButton(ACanvas, ARect, scsHot{$IFDEF VER340_UP}, AControl{$ENDIF});
    finally
      RestoreDC(ACanvas.Handle, SaveIndex);
    end;
    SaveIndex := SaveDC(ACanvas.Handle);
    try
      IntersectClipRect(ACanvas.Handle, CR.Left, CR.Top, CR.Right, CR.Bottom);
      DrawToolButton(ACanvas, ARect, scsPressed{$IFDEF VER340_UP}, AControl{$ENDIF});
    finally
      RestoreDC(ACanvas.Handle, SaveIndex);
    end;
  end;
...
begin
  ...
  begin
    ...
    if LStyle.GetElementSize(ACanvas.Handle,
         LStyle.GetElementDetails(tbCheckBoxCheckedNormal),
         LRect, ElementSize, BoxSize{$IFDEF VER330_UP},FDPI{$ENDIF}) then
    begin
      Result := BoxSize.cx;
      {$IFNDEF VER330_UP}
      if SC_SCALETHEMES and
      not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} and (Abs(BoxSize.cx - Round(13 * AScaleFactor)) > AScaleFactor) then
    ...
    Result := 13;
  {$IFNDEF VER340_UP}
  if (AScaleFactor > 1) and (IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} or not LStyle.Enabled) then
    Result := Round(Result * AScaleFactor);
  {$ENDIF}
end;

procedure DrawTreeCheckBox(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState;
  ACheckBoxState: TCheckBoxState; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
...
var
  Details:  TThemedElementDetails;
  R{$IFNDEF VER340_UP}, R1{$ENDIF}: TRect;
  SaveIndex, Size: Integer;
  BoxSize{$IFNDEF VER340_UP}, ScaleBoxSize{$ENDIF}: TSize;
  ElementSize: TElementSize;
  {$IFNDEF VER340_UP}
  Buffer: TBitmap;
  {$ENDIF}
...
begin
  ...
  begin
      ...
      scsNormal:
         begin
           case ACheckBoxState of
            cbUnChecked: Details := LStyle.GetElementDetails(tbCheckBoxUncheckedNormal);
            cbChecked: Details := LStyle.GetElementDetails(tbCheckBoxCheckedNormal);
            cbGrayed: Details := LStyle.GetElementDetails(tbCheckBoxMixedNormal);
          end
         end;
      scsHot:
        begin
          case ACheckBoxState of
            cbUnChecked: Details := LStyle.GetElementDetails(tbCheckBoxUncheckedHot);
            cbChecked: Details := LStyle.GetElementDetails(tbCheckBoxCheckedHot);
            cbGrayed: Details := LStyle.GetElementDetails(tbCheckBoxMixedHot);
          end
        end;
      scsPressed:
        begin
          case ACheckBoxState of
            cbUnChecked: Details := LStyle.GetElementDetails(tbCheckBoxUncheckedPressed);
            cbChecked: Details := LStyle.GetElementDetails(tbCheckBoxCheckedPressed);
            cbGrayed: Details := LStyle.GetElementDetails(tbCheckBoxMixedPressed);
          end
        end;
      scsDisabled:
        begin
          case ACheckBoxState of
            cbUnChecked: Details := LStyle.GetElementDetails(tbCheckBoxUncheckedDisabled);
            cbChecked: Details := LStyle.GetElementDetails(tbCheckBoxCheckedDisabled);
            cbGrayed: Details := LStyle.GetElementDetails(tbCheckBoxMixedDisabled);
          end
        end;
    end;
    R := ARect;
    ElementSize := esActual;
    if not LStyle.GetElementSize(ACanvas.Handle,
       LStyle.GetElementDetails(tbCheckBoxCheckedNormal),
    ...
    try
      ...
      LStyle.DrawElement(ACanvas.Handle, Details, R, nil, FDPI);
      {$ELSE}
      if {$IFDEF VER330_UP}False{$ELSE}SC_SCALETHEMES{$ENDIF} and
        not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF}  and
      ...
      if not (IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} and (AScaleFactor >= 1.25) and SC_SCALESTYLES) then
      begin
        if IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} and (AScaleFactor >= 1.25)  then
        begin
        ...
        begin
          ...
          if R.Right > ARect.Right then
            OffsetRect(R, -(R.Right - ARect.Right), 0);
          LStyle.DrawElement(ACanvas.Handle, Details, R{$IFDEF VER330_UP}, nil, FDPI{$ENDIF});
        end;
      end
      else
      begin
  ...
  begin
    case ACtrlState of
      scsNormal:
         begin
           case ACheckBoxState of
            cbUnChecked: Details := LStyle.GetElementDetails(tbRadioButtonUncheckedNormal);
            cbChecked: Details := LStyle.GetElementDetails(tbRadioButtonCheckedNormal);
          end
         end;
      scsHot:
        begin
          case ACheckBoxState of
            cbUnChecked: Details := LStyle.GetElementDetails(tbRadioButtonUncheckedHot);
            cbChecked: Details := LStyle.GetElementDetails(tbRadioButtonCheckedHot);
          end
        end;
      scsPressed:
        begin
          case ACheckBoxState of
            cbUnChecked: Details := LStyle.GetElementDetails(tbRadioButtonUncheckedPressed);
            cbChecked: Details := LStyle.GetElementDetails(tbRadioButtonCheckedPressed);
          end
        end;
      scsDisabled:
        begin
          case ACheckBoxState of
            cbUnChecked: Details := LStyle.GetElementDetails(tbRadioButtonUncheckedDisabled);
            cbChecked: Details := LStyle.GetElementDetails(tbRadioButtonCheckedDisabled);
          end
        end;
    end;
    R := ARect;
...
begin
  ...
  try
    if (LStyle.Enabled and not IsWindowsXP) or IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
    begin
      Bitmap_ClearAlpha(B, 0);
      B.AlphaFormat := afPremultiplied;
      if not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
        Details := LStyle.GetElementDetails(tmcGridCellBackgroundSelected)
      else
        Details :=  LStyle.GetElementDetails(tgCellSelected);
...
begin
  if ARect.Width * ARect.Height <= 0 then Exit;
  LStyle := StyleServices{$IFDEF VER340_UP}(AControl){$ENDIF};
  if IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} and not AFocused and not AFocusedSelection then
  begin
    DrawSelectionWithAlpha(ACanvas, ARect, 175{$IFDEF VER340_UP}, AControl{$ENDIF});
  end
  else
  if LStyle.Enabled and not (IsWindowsXP and not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF}) then
  begin
    if not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
    begin
      if not AFocused and not AFocusedSelection then
        Details := LStyle.GetElementDetails(tmcGridCellBackgroundSelectedNotFocused)
      else
        Details := LStyle.GetElementDetails(tmcGridCellBackgroundSelected);
    end
    else
...
begin
  ...
  begin
    SaveIndex := SaveDC(ACanvas.Handle);
    LStyle := StyleServices{$IFDEF VER340_UP}(AControl){$ENDIF};
    Details := LStyle.GetElementDetails(tcpThemedHeader);
    try
      LStyle.DrawElement(ACanvas.Handle, Details, ARect);
    finally
      RestoreDC(ACanvas.Handle, SaveIndex);
  ...
  begin
    case ACtrlState of
      scsNormal, scsDisabled:
         Details := LStyle.GetElementDetails(tgFixedCellNormal);
      scsHot, scsFocused:
         Details := LStyle.GetElementDetails(tgFixedCellHot);
      scsPressed:
         Details := LStyle.GetElementDetails(tgFixedCellPressed);
    end;
   SaveIndex := SaveDC(ACanvas.Handle);
   try
     LStyle.DrawElement(ACanvas.Handle, Details, ARect);
...
begin
  ...
  begin
    R := ARect;
    C := GetStyleColor(clBtnFace{$IFDEF VER340_UP}, AControl{$ENDIF});
    Frm3D(ACanvas, R, C, C);
    Frm3D(ACanvas, R, C, C);
    case ACtrlState of
      scsNormal: Details := LStyle.GetElementDetails(tcBorderNormal);
      scsHot: Details := LStyle.GetElementDetails(tcBorderHot);
      scsFocused: Details := LStyle.GetElementDetails(tcBorderFocused);
      scsDisabled: Details := LStyle.GetElementDetails(tcBorderDisabled);
    end;
    LStyle.DrawElement(ACanvas.Handle, Details, ARect);
  end
  else
    DrawEditBorder(ACanvas, ARect, ACtrlState{$IFDEF VER340_UP}, AControl{$ENDIF});
end;
...
begin
  ...
  begin
    ...
    Frm3D(ACanvas, R, C, C);
    case ACtrlState of
      scsNormal: Details := LStyle.GetElementDetails(teEditBorderNoScrollNormal);
      scsHot: Details := LStyle.GetElementDetails(teEditBorderNoScrollHot);
      scsFocused:
       if IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
...
begin
  LStyle := StyleServices{$IFDEF VER340_UP}(AControl){$ENDIF};
  if IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
    C := LStyle.GetSystemColor(clBtnShadow)
  else
    C:= clBtnShadow;
  Frm3D(ACanvas, ARect, C, C);
  if IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
    C := LStyle.GetSystemColor(clWindow)
  else
    C:= clWindow;
  Frm3D(ACanvas, ARect, C, C);
end;
...
procedure DrawDropDownButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState;
  ANewStyle: Boolean; ARightToLeft: Boolean; AScaleFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
var
  Details:  TThemedElementDetails;
  {$IFDEF VER330_UP}
  FDPI: Integer;
...
begin
  ...
  if ANewStyle and not ARightToLeft and
    not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} and LStyle.Enabled and CheckWin32Version(6, 0) then
  begin
    Inc(ARect.Right);
    Inc(ARect.Bottom);
    Dec(ARect.Top);
    case ACtrlState of
      scsNormal:
         Details := LStyle.GetElementDetails(tcDropDownButtonRightNormal);
      scsHot, scsFocused:
         Details := LStyle.GetElementDetails(tcDropDownButtonRightHot);
      scsPressed:
         Details := LStyle.GetElementDetails(tcDropDownButtonRightPressed);
      scsDisabled:
         Details := LStyle.GetElementDetails(tcDropDownButtonRightDisabled);
    end;
    LStyle.DrawElement(ACanvas.Handle, Details, ARect{$IFDEF VER330_UP}, nil, FDPI{$ENDIF});
  end
  else
  ...
  begin
    ...
    case ACtrlState of
      scsNormal:
         Details := LStyle.GetElementDetails(tcDropDownButtonLeftNormal);
      scsHot, scsFocused:
         Details := LStyle.GetElementDetails(tcDropDownButtonLeftHot);
      scsPressed:
         Details := LStyle.GetElementDetails(tcDropDownButtonLeftPressed);
      scsDisabled:
         Details := LStyle.GetElementDetails(tcDropDownButtonLeftDisabled);
    end;
    LStyle.DrawElement(ACanvas.Handle, Details, ARect{$IFDEF VER330_UP}, nil, FDPI{$ENDIF});
  end
  else
  ...
  begin
    case ACtrlState of
      ...
      scsHot, scsFocused:
         Details := LStyle.GetElementDetails(tcDropDownButtonHot);
      scsPressed:
         Details := LStyle.GetElementDetails(tcDropDownButtonPressed);
      scsDisabled:
...
begin
  ...
  {$IFDEF VER340_UP}
  if AScaleFactor < 1 then AScaleFactor := 1;
  LDPI := Round(96 * AScaleFactor);
  {$ENDIF}
  if LStyle.Enabled then
  begin
    if AVertical then
      Details := LStyle.GetElementDetails(ttbTrackVert)
    else
      Details := LStyle.GetElementDetails(ttbTrack);
    {$IFDEF VER340_UP}
    if IsCustomStyle(AControl) then
      LStyle.DrawElement(ACanvas.Handle, Details, ARect{$IFDEF VER340_UP}, nil, LDPI{$ENDIF})
    else
    {$ENDIF}
    LStyle.DrawElement(ACanvas.Handle, Details, ARect);
  end
...
begin
  ...
  if LStyle.Enabled then
  begin
    Details := LStyle.GetElementDetails(ttbThumbNormal);
    if AVertical then
    begin
      case ACtrlState of
        scsNormal: Details := LStyle.GetElementDetails(ttbThumbVertNormal);
        scsHot: Details := LStyle.GetElementDetails(ttbThumbVertHot);
        scsPressed: Details := LStyle.GetElementDetails(ttbThumbVertPressed);
        scsDisabled: Details := LStyle.GetElementDetails(ttbThumbVertDisabled);
      end;
    end
    else
      case ACtrlState of
        scsNormal: Details := LStyle.GetElementDetails(ttbThumbNormal);
        scsHot: Details := LStyle.GetElementDetails(ttbThumbHot);
        scsPressed: Details := LStyle.GetElementDetails(ttbThumbPressed);
        scsDisabled: Details := LStyle.GetElementDetails(ttbThumbDisabled);
      end;
    {$IFNDEF VER340_UP}
    ...
    {$ELSE}
      if IsCustomStyle(AControl) then
        LStyle.DrawElement(ACanvas.Handle, Details, ARect, nil, LDPI)
      else
        LStyle.DrawElement(ACanvas.Handle, Details, ARect);
    {$ENDIF}
  end
...
begin
  ...
  if (ACtrlState <> scsFocused) and not StyleServices{$IFDEF VER340_UP}(AControl){$ENDIF}.Enabled
  then
  begin
    Inc(ARect.Top, 2);
  end;
  ...
  if ACtrlState = scsDisabled then
    DrawTabWithAlpha(ACanvas, ARect, 150{$IFDEF VER340_UP}, AControl{$ENDIF})
  else
    DrawTab(ACanvas, ARect, ACtrlState, tpTop, False, False{$IFDEF VER340_UP}, AControl{$ENDIF});
end;
  ...
  begin
    ...
    tpTop:
      begin
        if ACtrlState = scsFocused then
        begin
          if not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} and AFirst then
            DrawCtrlState := ttTabItemLeftEdgeSelected
          else
          if not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} and ALast then
            DrawCtrlState := ttTabItemRightEdgeSelected
          else
            DrawCtrlState := ttTabItemSelected;
        end
        else
        if (ACtrlState <> scsFocused) and IsWindows10 and AFirst and not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
        begin
          case ACtrlState of
            scsNormal:
    ...
    Details := LStyle.GetElementDetails(DrawCtrlState);
    SaveIndex := SaveDC(ACanvas.Handle);
    try
      LStyle.DrawElement(ACanvas.Handle, Details, ARect);
    finally
...
begin
  ...
  try
    ...
    begin
      Bitmap_ClearAlpha(B, 0);
      B.AlphaFormat := afPremultiplied;
      Details :=  LStyle.GetElementDetails(ttTabItemNormal);
      LStyle.DrawElement(B.Canvas.Handle, Details, R);
    end;
    Bitmap_DrawAlpha_XY(B, ACanvas, ARect.Left, ARect.Top, AAlpha);
  finally
...
begin
  ...
  try
    ...
    begin
      Bitmap_ClearAlpha(B, 0);
      B.AlphaFormat := afPremultiplied;
      Details :=  LStyle.GetElementDetails(tmPopupItemHot);
      LStyle.DrawElement(B.Canvas.Handle, Details, R);
    end
    else
    begin
...
begin
  ...
  if LStyle.Enabled then
  begin
    Details := LStyle.GetElementDetails(tmPopupBorders);
    LStyle.DrawElement(ACanvas.Handle, Details, ARect);
  end
  else
  with ACanvas do
...
begin
  ...
  if LStyle.Enabled then
  begin
    Details := LStyle.GetElementDetails(tmPopupItemNormal);
    if ACtrlState = scsHot then
      Details := LStyle.GetElementDetails(tmPopupItemHot)
    else
    if ACtrlState = scsDisabled then
       Details := LStyle.GetElementDetails(tmPopupItemDisabled);
    LStyle.DrawElement(ACanvas.Handle, Details, ARect);
  end
  else
  with ACanvas do
...
begin
  LStyle := StyleServices{$IFDEF VER340_UP}(AControl){$ENDIF};
  if IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
    Result := LStyle.GetStyleColor(ColorStates[ACtrlState = scsNormal])
  else
    Result := clWindow;
end;
...
var
  C: TColor;
begin
  C := GetStyleColor(clHighLight{$IFDEF VER340_UP}, AControl{$ENDIF});
  if not IsDarkStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
...
begin
  ...
  begin
    LStyle := StyleServices{$IFDEF VER340_UP}(AControl){$ENDIF};
    Result := LStyle.GetStyleFontColor(FontColorStates[ACtrlState = scsNormal])
  end
  else
  if ACtrlState = scsDisabled then
    Result := clGrayText
...
begin
  ...
  begin
    ...
    case ACtrlState of
      scsHot, scsFocused:
        Details := LStyle.GetElementDetails(tbCheckBoxUncheckedHot);
      scsPressed:
        Details := LStyle.GetElementDetails(tbCheckBoxUncheckedPressed);
      scsDisabled:
        Details := LStyle.GetElementDetails(tbCheckBoxUncheckedDisabled);
    end;
    if not LStyle.GetElementColor(Details, ecTextColor, FColor) then
      FColor := clBtnText;
  end;
...
begin
  ...
  begin
    LStyle := StyleServices{$IFDEF VER340_UP}(AControl){$ENDIF};
    Details := LStyle.GetElementDetails(tbRadioButtonUncheckedNormal);
    case ACtrlState of
      scsHot:
        Details := LStyle.GetElementDetails(tbRadioButtonUncheckedHot);
      scsPressed:
        Details := LStyle.GetElementDetails(tbRadioButtonUncheckedPressed);
      scsDisabled:
        Details := LStyle.GetElementDetails(tbRadioButtonUncheckedDisabled);
     end;
     if not LStyle.GetElementColor(Details, ecTextColor, FColor) then
       FColor := clBtnFace;
  end;
...
begin
  if IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} then
    Result := StyleServices{$IFDEF VER340_UP}(AControl){$ENDIF}.GetSystemColor(AColor)
  else
    Result := AColor;
end;
...
begin
  ...
  LStyle := StyleServices{$IFDEF VER340_UP}(AControl){$ENDIF};
  LIsCustomStyle := IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF};
  if LStyle.Enabled and not (IsWindowsXP and not LIsCustomStyle) then
  begin
    if IsWindows11 and not LIsCustomStyle then
      FColor := clWindowText
    else
    begin
      Details := LStyle.GetElementDetails(tgCellSelected);
...
begin
  if ACtrlState = scsPressed then
     ACtrlState := scsFocused;
  Result := GetTabTextColor(ACtrlState{$IFDEF VER340_UP}, AControl{$ENDIF});
end;
...
begin
  ...
  begin
    ...
    case ACtrlState of
      scsFocused:
        Details := LStyle.GetElementDetails(ttTabItemSelected);
      scsHot:
        Details := LStyle.GetElementDetails(ttTabItemHot);
      scsDisabled:
        Details := LStyle.GetElementDetails(ttTabItemDisabled);
    end;
    if not LStyle.GetElementColor(Details, ecTextColor, FColor) then
      FColor := clBtnFace;
  end;
...
begin
  ...
  begin
    LStyle := StyleServices{$IFDEF VER340_UP}(AControl){$ENDIF};
    if ACtrlState = scsDisabled then
      Details := LStyle.GetElementDetails(twCaptionInActive)
    else
      Details := LStyle.GetElementDetails(twCaptionActive);
    if not LStyle.GetElementColor(Details, ecTextColor, FColor) then
      FColor := clBtnText;
    Result := FColor;
  end
...
begin
 ...
 if (AMargin = -1) and (tw <> 0) then
 begin
   if (ALayout = blGlyphLeft) or (ALayout = blGlyphRight) then
   begin
     if tw + gw + ASpacing > ARect.Width then
       AMargin := 0;
   end
   else
   begin
     if th + gh + ASpacing > ARect.Height then
       AMargin := 0;
   end;
 end;
    ...
    begin
      ...
      begin
        if AEnabled then
          ...
          ImageList_DrawEx(AImageList.Handle, AImageIndex, ACanvas.Handle, GX, GY, AImageList.Width, AImageList.Height,
            CLR_NONE, CLR_NONE, ILD_BLEND25);
      end
      else
      if AEnabled then
         AImageList.Draw(ACanvas, GX, GY, AImageIndex, True)
      else
      if (AImageList is TscCustomImageList) or (AImageList.ClassName = 'TVirtualImageList') then
...
begin
  ...
  then
    begin
      ...
      if AEndEllipsis and ((ALayout = blGlyphLeft) or (ALayout = blGlyphRight)) then
      begin
        if TR.Right > ARect.Right then
          TR.Right := ARect.Right;
        Flags := Flags or DT_END_ELLIPSIS;
        if gw > 0 then
        begin
          if (TR.Left < gx + gw + 4) and (ALayout = blGlyphLeft) then
            TR.Left := gx + gw + 4
          else
          if (TR.Right > gx) and (ALayout = blGlyphRight) then
            TR.Right := gx - 4;
        end;
      end;
...
begin
  ...
  case AAlignment of
    taLeftJustify:
      DrawText(ACanvas.Handle, PChar(AText), Length(AText), ARect,
        scDrawTextBidiModeFlags(DT_VCENTER or DT_WORDBREAK or DT_LEFT or DT_NOPREFIX or DT_NOCLIP, ARightToLeft));
    taRightJustify:
      DrawText(ACanvas.Handle, PChar(AText), Length(AText), ARect,
        scDrawTextBidiModeFlags(DT_VCENTER or DT_WORDBREAK or DT_RIGHT or DT_NOPREFIX or DT_NOCLIP, ARightToLeft));
    taCenter:
      DrawText(ACanvas.Handle, PChar(AText), Length(AText), ARect,
       scDrawTextBidiModeFlags(DT_VCENTER or DT_WORDBREAK or DT_CENTER or DT_NOPREFIX or DT_NOCLIP, ARightToLeft));
  end;
end;
...
var
  LFlags: Integer;
begin
  LFlags := DT_VCENTER or DT_SINGLELINE or DT_NOPREFIX or DT_NOCLIP;
  ...
  if AShowEllipsis then
    LFlags := LFlags or DT_END_ELLIPSIS;
  
  DrawText(ACanvas.Handle, PChar(AText), Length(AText), ARect,
    scDrawTextBidiModeFlags(LFlags, ARightToLeft));
end;
...
begin
  ...
  if AImageList.ShareImages then
    ImageList_DrawEx(AImageList.Handle, AImageIndex, ACanvas.Handle, AX, AY, AImageList.Width, AImageList.Height,
      CLR_NONE, CLR_NONE, ILD_NORMAL)
  else
  ...
  then
    begin
      ...
      if AWordWrap then
         Flags := Flags or DT_WORDBREAK;
      TR := Rect(TX, TY, TX + tw, TY + th);
      DrawTextWithGlow(ACanvas, TR, AText, Flags,
...
begin
  ...
  if LStyle.Enabled then
  begin
    C1 := LStyle.GetSystemColor(clBtnShadow);
    C2 := LStyle.GetSystemColor(clBtnHighLight);
  end
  else
  begin
    C1 := clBtnShadow;
...
procedure DrawVertSplitter2(ACanvas: TCanvas; ARect: TRect{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
var
  Buffer: TBitmap;
  C1, C2: TColor;
  LStyle: TCustomStyleServices;
...
begin
  ...
  begin
    ...
    DrawStatusBar(ADest, R{$IFDEF VER340_UP}, AControl.Parent{$ENDIF});
    DrawStatusPanel(ADest, R{$IFDEF VER340_UP}, AControl.Parent{$ENDIF});
    Exit;
  end;
  ...
  begin
    ...
    try
      DrawTabFrame(FCanvas, Rect(-AControl.Parent.Left, -AControl.Parent.Top,
        ...
        AControl.Parent.ClientHeight + AControl.Parent.Top){$IFDEF VER340_UP}, AControl.Parent.Parent{$ENDIF});
    finally
      FCanvas.Handle := 0;
      FCanvas.Free;
    end;
  ...
  LStyle := StyleServices{$IFDEF VER340_UP}(AControl.Parent){$ENDIF};

  if IsCustomStyle{$IFDEF VER340_UP}(AControl.Parent){$ENDIF} and not (AControl.Parent.ClassName = 'TscToolBar') then
  begin
    LStyle.DrawParentBackground(AControl.Handle, ADest.Handle, nil, False);
    Exit;
  end;
  ...
  try
    ...
    SaveIndex := SaveDC(DC);
     try
      ...
      if (AControl.Parent.ClassName = 'TscToolBar') then
      begin
        FCanvas := TCanvas.Create;
        FCanvas.Handle := DC;
        try
          DrawToolBar(FCanvas, Rect(-AControl.Parent.Left, -AControl.Parent.Top,
            AControl.Parent.ClientWidth + AControl.Parent.Left,
            AControl.Parent.ClientHeight + AControl.Parent.Top){$IFDEF VER340_UP}, AControl.Parent{$ENDIF});
        finally
          FCanvas.Handle := 0;
          FCanvas.Free;
        end;
      ...
      if ((AControl.Parent is TTabSheet) and LStyle.Enabled and
         ...
         ((AControl.Parent.ClassName = 'TTabPage') and LStyle.Enabled) then
      begin
        FCanvas := TCanvas.Create;
        FCanvas.Handle := DC;
        try
...
begin
  ...
  try
    ...
    with Buffer.Canvas do
    begin
      Brush.Color := GetStyleColor(clBtnFace{$IFDEF VER340_UP}, AControl{$ENDIF});
      Pen.Color := MiddleColor(ABorderColor, GetStyleColor(clBtnFace{$IFDEF VER340_UP}, AControl{$ENDIF}));
      Rectangle(0, 0, Buffer.Width, Buffer.Height);
      Pen.Color := GetStyleColor(clBtnHighLight{$IFDEF VER340_UP}, AControl{$ENDIF});
      MoveTo(1,1); LineTo(Buffer.Width - 1, 1);
      C := MiddleColor(GetStyleColor(clBtnText{$IFDEF VER340_UP}, AControl{$ENDIF}), GetStyleColor(clBtnFace{$IFDEF VER340_UP}, AControl{$ENDIF}));
      Pen.Color := MiddleColor(GetStyleColor(clBtnText{$IFDEF VER340_UP}, AControl{$ENDIF}), C);
      MoveTo(2, Size div 2);
      LineTo(Buffer.Width - 2, Size div 2);
      if not AExpanded then
      begin
...
begin
  ...
  begin
    Details := LStyle.GetElementDetails(tsArrowBtnUpNormal);
    case ACtrlState of
      scsHot:  Details := LStyle.GetElementDetails(tsArrowBtnUpHot);
      scsPressed: Details := LStyle.GetElementDetails(tsArrowBtnUpPressed);
      scsDisabled:  Details := LStyle.GetElementDetails(tsArrowBtnUpDisabled);
    end;
    LStyle.DrawElement(ACanvas.Handle, Details, ARect{$IFDEF VER330_UP},nil, FDPI{$ENDIF});
  end
  else
...
begin
  ...
  begin
    Details := LStyle.GetElementDetails(tsArrowBtnDownNormal);
    case ACtrlState of
      scsHot: Details := LStyle.GetElementDetails(tsArrowBtnDownHot);
      scsPressed: Details := LStyle.GetElementDetails(tsArrowBtnDownPressed);
      scsDisabled: Details := LStyle.GetElementDetails(tsArrowBtnDownDisabled);
    end;
    LStyle.DrawElement(ACanvas.Handle, Details, ARect{$IFDEF VER330_UP},nil, FDPI{$ENDIF});
  end
  else
...
begin
  ...
  begin
    Details := LStyle.GetElementDetails(tsArrowBtnLeftNormal);
    case ACtrlState of
      scsHot:  Details := LStyle.GetElementDetails(tsArrowBtnLeftHot);
      scsPressed: Details := LStyle.GetElementDetails(tsArrowBtnLeftPressed);
      scsDisabled:  Details := LStyle.GetElementDetails(tsArrowBtnLeftDisabled);
    end;
    LStyle.DrawElement(ACanvas.Handle, Details, ARect{$IFDEF VER330_UP},nil, FDPI{$ENDIF});
  end
  else
...
begin
  ...
  begin
    Details := LStyle.GetElementDetails(tsArrowBtnRightNormal);
    case ACtrlState of
      scsHot:  Details := LStyle.GetElementDetails(tsArrowBtnRightHot);
      scsPressed: Details := LStyle.GetElementDetails(tsArrowBtnRightPressed);
      scsDisabled:  Details := LStyle.GetElementDetails(tsArrowBtnRightDisabled);
    end;
    LStyle.DrawElement(ACanvas.Handle, Details, ARect{$IFDEF VER330_UP},nil, FDPI{$ENDIF});
  end
  else
...
begin
  ...
  if LStyle.Enabled then
  begin
    Details := LStyle.GetElementDetails(tsThumbBtnHorzNormal);
    case ACtrlState of
      scsHot:  Details := LStyle.GetElementDetails(tsThumbBtnHorzHot);
      scsPressed: Details := LStyle.GetElementDetails(tsThumbBtnHorzPressed);
      scsDisabled:  Details := LStyle.GetElementDetails(tsThumbBtnHorzDisabled);
    end;
    LStyle.DrawElement(ACanvas.Handle, Details, ARect{$IFDEF VER340_UP}, nil, FDPI{$ENDIF});
    if not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} and (ARect.Width > 17) and not IsWindows10 then
    begin
      Details := LStyle.GetElementDetails(tsGripperHorzNormal);
      case ACtrlState of
        scsHot:  Details := LStyle.GetElementDetails(tsGripperHorzHot);
        scsPressed: Details := LStyle.GetElementDetails(tsGripperHorzPressed);
        scsDisabled:  Details := LStyle.GetElementDetails(tsGripperHorzDisabled);
      end;
      LStyle.DrawElement(ACanvas.Handle, Details, ARect);
    end;
  end
...
begin
  ...
  if LStyle.Enabled then
  begin
    Details := LStyle.GetElementDetails(tsThumbBtnVertNormal);
    case ACtrlState of
      scsHot:  Details := LStyle.GetElementDetails(tsThumbBtnVertHot);
      scsPressed: Details := LStyle.GetElementDetails(tsThumbBtnVertPressed);
      scsDisabled:  Details := LStyle.GetElementDetails(tsThumbBtnVertDisabled);
    end;
    LStyle.DrawElement(ACanvas.Handle, Details, ARect{$IFDEF VER340_UP}, nil, FDPI{$ENDIF});
    if not IsCustomStyle{$IFDEF VER340_UP}(AControl){$ENDIF} and (ARect.Height > 17) and not IsWindows10 then
    begin
      Details := LStyle.GetElementDetails(tsGripperVertNormal);
      case ACtrlState of
        scsHot:  Details := LStyle.GetElementDetails(tsGripperVertHot);
        scsPressed: Details := LStyle.GetElementDetails(tsGripperVertPressed);
        scsDisabled:  Details := LStyle.GetElementDetails(tsGripperVertDisabled);
      end;
      LStyle.DrawElement(ACanvas.Handle, Details, ARect);
    end;
  end
...
begin
  ...
  LText := AEdit.Text;
  LSelPos := AEdit.SelStart;
  if AEdit.SelLength <> 0 then
    Delete(LText, LSelPos + 1, AEdit.SelLength);
  Insert(AText, LText, LSelPos + 1);
  AEdit.Text := LText;
  Inc(LSelPos, Length(AText));
  AEdit.SelLength := 0;
  AEdit.SelStart := LSelPos;
  SendMessage(AEdit.Handle, EM_SCROLLCARET, 0, 0);
end;
...
initialization
  ...
  GetWindows10BuildNumber(FWindows10Build);
  SetupuxTheme;
  SetupDWM;
  SetupUser32;
