...
type
  ...
  private
    ...
    FThumbMarginHot: Integer;
    FThumbMarginPressed: Integer;
    procedure SetThumbMargin(Value: Integer);
    procedure SetThumbMarginHot(Value: Integer);
    procedure SetThumbMarginPressed(Value: Integer);
  ...
  published
    ...
    property ThumbMargin: Integer
      read FThumbMargin write SetThumbMargin;
    property ThumbMarginHot: Integer
      read FThumbMarginHot write SetThumbMarginHot;
    property ThumbMarginPressed: Integer
      read FThumbMarginPressed write SetThumbMarginPressed;
  ...
  TscGPThumbShapeStyle = (scgptssRoundRect, scgptssCircle, scgptssRoundedFrame, scgptssRoundedBorder);

  TscGPTrackBar = class(TscCustomTrackBar)
  private
    FTrackRounded: Boolean;
    FTrackAlpha: Byte;
    FTrackProgressAlpha: Byte;
    FThumbBorderInColor: TColor;
    FThumbBorderOutColor: TColor;
    FThumbShapeStyle: TscGPThumbShapeStyle;
    FFocusFrameColor: TColor;
    procedure SetTrackRounded(Value: Boolean);
    procedure SetThumbBorderInColor(Value: TColor);
    procedure SetThumbBorderOutColor(Value: TColor);
  ...
  published
   ...
   property TrackProgressColor: TColor
    ...
    property TrackRounded: Boolean
      read FTrackRounded write SetTrackRounded;
    property TrackProgressAlpha: Byte
      read FTrackProgressAlpha write SetTrackProgressAlpha;
    property ThumbBorderInColor: TColor
      read FThumbBorderInColor write SetThumbBorderInColor;
    property ThumbBorderOutColor: TColor
      read FThumbBorderOutColor write SetThumbBorderOutColor;
  ...
  TscGPButtonShapeStyle = (scgpRect, scgpRoundedRect, scgpRoundedLeftRight,
    ...
    scgpLeftRoundedLine, scgpTopRoundedLine, scgpRightRoundedLine, scgpBottomRoundedLine);
   ...
   TscGPButtonOptions = class(TPersistent)
    protected
      ...
      FShapeStyleLineSize: Integer;
      procedure SetShapeStyleLineSize(Value: Integer);
    ...
    published
      ...
      property NormalColor2: TColor read FNormalColor2 write SetNormalColor2;
      property HotColor2: TColor read FHotColor2 write SetHotColor2;
      property PressedColor2: TColor read FPressedColor2 write SetPressedColor2;
      property FocusedColor2: TColor read FFocusedColor2 write SetFocusedColor2;
      property DisabledColor2: TColor read FDisabledColor2 write SetDisabledColor2;
      ...
      property ShapeStyleLineSize: Integer
        read FShapeStyleLineSize write SetShapeStyleLineSize;
      ...
      property ArrowNormalColor: TColor read FArrowNormalColor write SetArrowNormalColor;
      property ArrowHotColor: TColor read FArrowHotColor write SetArrowHotColor;
      property ArrowPressedColor: TColor read FArrowPressedColor write SetArrowPressedColor;
      property ArrowFocusedColor: TColor read FArrowFocusedColor write SetArrowFocusedColor;
      property ArrowDisabledColor: TColor read FArrowDisabledColor write SetArrowDisabledColor;
    ...
    published
      ...
      property CheckMarkHotColor: TColor read FCheckMarkHotColor write SetCheckMarkHotColor;
      property CheckMarkPressedColor: TColor read FCheckMarkPressedColor write SetCheckMarkPressedColor;
  ...
  TscGPButtonGlyphKind =
    (scgpbgkPriorArrow, scgpbgkNextArrow, scgpbgkLeftArrow, scgpbgkRightArrow,
     ...
     scgpbgkColorMarker,
     scgpbgkMaximizeRounded, scgpbgkRestoreRounded,
     scgpbgkMaximizeRect, scgpbgkRestoreRect);
  ...
  protected
    ...
    FDragPoint: TPoint;
    FDown: Boolean;
    FResizeTargetControl: TWinControl;
  ...
  published
    ...
    property ResizeTargetControl: TWinControl
      read FResizeTargetControl write FResizeTargetControl;
  end;
  ...
  procedure GPDrawImageAndText(AGraphics: TGPGraphics; ACanvas: TCanvas; ARect: TRect; AMargin, ASpacing: Integer;
              ...
              ARightToLeft: Boolean; ANoPrefix: Boolean; AScaleDrawFactor: Double = 1; AWordWrap: Boolean = True; AEndEllipsis: Boolean = False; ACaptionCenterAlignment: Boolean = False);
...
begin
  ...
  begin
    ...
    if not ANoPrefix then
      LGPStringFormat.SetHotkeyPrefix(HotkeyPrefixShow);
    LGPStringFormat.SetFormatFlags(Flags);
    if ((ALayout = blGlyphLeft) or (ALayout = blGlyphRight)) and not ACaptionCenterAlignment then
      LGPStringFormat.SetAlignment(StringAlignment.StringAlignmentNear)
    else
      LGPStringFormat.SetAlignment(StringAlignment.StringAlignmentCenter);
...
begin
  ...
  if IsCustomStyle{$IFDEF VER340_UP}(Self){$ENDIF} and (seClient in StyleElements) then
    C := GetStyleColor(FPointColor{$IFDEF VER340_UP}, Self{$ENDIF})
  else
    C := FPointColor;
  G := TGPGraphics.Create(ACanvas.Handle);
...
procedure TscGPSwitch.SetFrameWidth(Value: Integer);
begin
  if (Value > 0) and (Value <> FFrameWidth) then
  begin
    FFrameWidth := Value;
    RePaintControl;
  end;
...
procedure TscGPSwitch.SetThumbMargin(Value: Integer);
begin
  if (FThumbMargin <> Value) and (Value >= 0) then
  begin
    FThumbMargin := Value;
    RePaintControl;
  end;
...
procedure TscGPSwitch.SetThumbMarginHot(Value: Integer);
begin
  if (FThumbMarginHot <> Value) and (Value >= 0) then
  begin
    FThumbMarginHot := Value;
    RePaintControl;
  end;
end;

procedure TscGPSwitch.SetThumbMarginPressed(Value: Integer);
begin
  if (FThumbMarginPressed <> Value) and (Value >= 0) then
  begin
    FThumbMarginPressed := Value;
    RePaintControl;
  end;
end;
...
begin
  ...
  FrmSize := Round(FFrameWidth * FScaleFactor);

  if FPressed and (FThumbMarginPressed > 0) then
    InflateRect(ThumbR,
      -Round(FThumbMarginPressed * FScaleFactor),
      -Round(FThumbMarginPressed * FScaleFactor))
  else
  if FMouseIn and (FThumbMarginHot > 0) then
    InflateRect(ThumbR,
      -Round(FThumbMarginHot * FScaleFactor),
      -Round(FThumbMarginHot * FScaleFactor))
  else
  if FThumbMargin > 0 then
    InflateRect(ThumbR,
      -Round(FThumbMargin * FScaleFactor),
      -Round(FThumbMargin * FScaleFactor))
  else
    InflateRect(ThumbR,
  ...
  begin
    ...
    if not Enabled then
      FAlpha := FAlpha div 2;
    FrmColor := ColorToGPColor(GetStyleColor(FramePressedColor{$IFDEF VER340_UP}, Self{$ENDIF}), FAlpha);
    FAlpha := FThumbPressedColorAlpha;
    if not Enabled then
      FAlpha := FAlpha div 2;
    ThmbColor := ColorToGPColor(GetStyleColor(ThumbPressedColor{$IFDEF VER340_UP}, Self{$ENDIF}), FAlpha);
  end
  else
  ...
  begin
    ...
    if FMouseIn and not ReadOnly then
      FrmColor := ColorToGPColor(LighterColor(GetStyleColor(FrameOnColor{$IFDEF VER340_UP}, Self{$ENDIF}), 10), FAlpha)
    else
      FrmColor := ColorToGPColor(GetStyleColor(FrameOnColor{$IFDEF VER340_UP}, Self{$ENDIF}), FAlpha);
    FAlpha := FThumbOnColorAlpha;
    if not Enabled then
      FAlpha := FAlpha div 2;
    if FMouseIn and not ReadOnly then
      ThmbColor := ColorToGPColor(LighterColor(GetStyleColor(ThumbOnColor{$IFDEF VER340_UP}, Self{$ENDIF}), 10), FAlpha)
    else
      ThmbColor := ColorToGPColor(GetStyleColor(ThumbOnColor{$IFDEF VER340_UP}, Self{$ENDIF}), FAlpha)
  end
  else
  begin
    ...
    if not Enabled then
      FAlpha := FAlpha div 2;
    if FMouseIn and not ReadOnly then
      FrmColor := ColorToGPColor(LighterColor(GetStyleColor(FrameColor{$IFDEF VER340_UP}, Self{$ENDIF}), 10), FAlpha)
    else
      FrmColor := ColorToGPColor(GetStyleColor(FrameColor{$IFDEF VER340_UP}, Self{$ENDIF}), FAlpha);
    FAlpha := FThumbColorAlpha;
    if not Enabled then
      FAlpha := FAlpha div 2;
    if FMouseIn and not ReadOnly then
      ThmbColor := ColorToGPColor(LighterColor(GetStyleColor(ThumbColor{$IFDEF VER340_UP}, Self{$ENDIF}), 10), FAlpha)
    else
      ThmbColor := ColorToGPColor(GetStyleColor(ThumbColor{$IFDEF VER340_UP}, Self{$ENDIF}), FAlpha);
  end;
...
begin
  ...
  FThumbBorderInColor := clWindow;
  FThumbBorderOutColor := clBtnShadow;
  FTrackRounded := False;
  FTrackAlpha := 255;
...
begin
  ...
  if FThumbShapeStyle in [scgptssCircle, scgptssRoundedFrame, scgptssRoundedBorder] then
  begin
    if FVertical then
      BW := Width - 4
    else
...
var
  PR, TR: TRect;
  TrackColor, LTrackProgressColor: Cardinal;
  G: TGPGraphics;
  B: TGPSolidBrush;
  P: TGPPen;
  LArc, RArc: TGPRectF;
  FillPath: TGPGraphicsPath;
  ThumbColor, ThumbBInColor, ThumbBOutColor: Cardinal;
  ThumbSize: Integer;
  C: TColor;
  R: TGPRectF;
begin
  ...
  TrackColor := ColorToGPColor(GetStyleColor(TrackOptions.Color{$IFDEF VER340_UP}, Self{$ENDIF}), FTrackAlpha);
  if not Enabled then
    LTrackProgressColor := ColorToGPColor(GetStyleColor(TrackOptions.ProgressColor{$IFDEF VER340_UP}, Self{$ENDIF}), FTrackProgressAlpha div 2)
  else
    LTrackProgressColor := ColorToGPColor(GetStyleColor(TrackOptions.ProgressColor{$IFDEF VER340_UP}, Self{$ENDIF}), FTrackProgressAlpha);
  ...
  ThumbColor := ColorToGPColor(GetStyleColor(C{$IFDEF VER340_UP}, Self{$ENDIF}), 255);
  ...
  try
    ...
    if FTrackRounded then
    begin
      scGPUtils.GPDrawHVRoundedLine(G, TrackSize, TrackR.Left, TrackR.Top,
        TrackR.Right, TrackR.Bottom, TrackColor);
      scGPUtils.GPDrawHVRoundedLine(G, TrackSize, PR.Left, PR.Top,
        PR.Right, PR.Bottom, LTrackProgressColor);
    end
    else
    begin
      B.SetColor(TrackColor);
      G.FillRectangle(B, RectToGPRect(TrackR));
      B.SetColor(LTrackProgressColor);
    ...
    if FThumbShapeStyle = scgptssRoundedBorder then
    begin
      TR := ThumbR;
      ThumbBInColor := ColorToGPColor(GetStyleColor(FThumbBorderInColor {$IFDEF VER340_UP}, Self{$ENDIF}), 255);
      ThumbBOutColor := ColorToGPColor(GetStyleColor(FThumbBorderOutColor {$IFDEF VER340_UP}, Self{$ENDIF}), 255);
      B.SetColor(ThumbBOutColor);
      LArc := RectToGPRect(TR);
      LArc.Width := LArc.Height;
      G.FillEllipse(B, LArc);
      B.SetColor(ThumbBInColor);
      InflateRect(TR, -Trunc(FScaleFactor), -Trunc(FScaleFactor));
      LArc := RectToGPRect(TR);
      LArc.Width := LArc.Height;
      G.FillEllipse(B, LArc);
      B.SetColor(ThumbColor);
      if FDown then
        ThumbSize := TR.Height div 3
      else
      if FMouseOver then
        ThumbSize := TR.Height div 6
      else
        ThumbSize := TR.Height div 4;

      InflateRect(TR, -ThumbSize, -ThumbSize);
      LArc := RectToGPRect(TR);
      LArc.Width := LArc.Height;
      G.FillEllipse(B, LArc);
    end
  ...
  begin
    if FFocusFrameColor <> clNone then
      FFocusFrameColor := GetStyleColor(FFocusFrameColor{$IFDEF VER340_UP}, Self{$ENDIF})
    else
      FFocusFrameColor := GetCheckBoxTextColor(scsNormal{$IFDEF VER340_UP}, Self{$ENDIF});
...
procedure TscGPTrackBar.SetThumbBorderInColor(Value: TColor);
begin
  if FThumbBorderInColor <> Value then
  begin
    FThumbBorderInColor := Value;
    RePaintControl;
  end;
end;

procedure TscGPTrackBar.SetThumbBorderOutColor(Value: TColor);
begin
  if FThumbBorderOutColor <> Value then
  begin
    FThumbBorderOutColor := Value;
    RePaintControl;
  end;
end;
...
procedure TscGPTrackBar.SetTrackRounded(Value: Boolean);
begin
  if FTrackRounded <> Value then
  begin
    FTrackRounded := Value;
    RePaintControl;
  end;
...
begin
  ...
  try
    // set colors
    FrmColor := ColorToGPColor(GetStyleColor(FFrameColor{$IFDEF VER340_UP}, Self{$ENDIF}), FFrameAlpha);
    ProgColor := ColorToGPColor(GetStyleColor(FProgressColor{$IFDEF VER340_UP}, Self{$ENDIF}), FProgressAlpha);
    // draw frame
    P.SetColor(FrmColor);
    ...
    begin
      ...
      ACanvas.Font.Color := GetStyleColor(ProgressFont.Color{$IFDEF VER340_UP}, Self{$ENDIF});
      TR1 := TR;
      if FShowCaption then
      begin
    ...
    begin
      ...
      ACanvas.Font.Color := GetStyleColor(Font.Color{$IFDEF VER340_UP}, Self{$ENDIF});
      if FDrawTextMode = scdtmGDI then
...
begin
  ...
  FColor := ColorToGPColor(GetStyleColor(FFrameColor{$IFDEF VER340_UP}, Self{$ENDIF}), FFrameAlpha);
  PColor := ColorToGPColor(GetStyleColor(FProgressColor{$IFDEF VER340_UP}, Self{$ENDIF}), FProgressAlpha);
...
begin
  ...
  begin
    ...
    FShapeStyleLineSize := TscGPButtonOptions(Source).FShapeStyleLineSize;
  end
  else
...
procedure TscGPButtonOptions.SetShapeStyleLineSize(Value: Integer);
begin
  if (Value >= 0) and (FShapeStyleLineSize <> Value) then
  begin
    FShapeStyleLineSize := Value;
    Changed;
  end;
end;
...
begin
  ...
  case FState of
    scsHot: Result := FHotColor2;
    scsPressed: Result := FPressedColor2;
    scsFocused: Result := FFocusedColor2;
    scsDisabled: Result := FDisabledColor2;
  end;
  if FStyleColors then
    Result := GetStyleColor(Result{$IFDEF VER340_UP}, FControl{$ENDIF});
end;
...
begin
  ...
  case FState of
    scsHot: Result := FArrowHotColor;
    scsPressed: Result := FArrowPressedColor;
    scsFocused: Result := FArrowFocusedColor;
    scsDisabled: Result := FArrowDisabledColor;
  end;
  if FStyleColors then
    Result := GetStyleColor(Result{$IFDEF VER340_UP}, FControl{$ENDIF});
end;
...
begin
  ...
  FOptions.FShapeStyleLineSize := MulDiv(FOptions.FShapeStyleLineSize, M, D);
...
begin
  ...
  begin
    FColor := GetStyleColor(Badge.Color{$IFDEF VER340_UP}, Self{$ENDIF});
    ACanvas.Font.Color := GetStyleColor(Badge.Font.Color{$IFDEF VER340_UP}, Self{$ENDIF});
  end
  else
    FColor := Badge.Color;
...
begin
  ...
  if (FrameColor <> 0) and not (FOptions.ShapeStyle in [scgpLeftRoundedLine, scgpTopRoundedLine, scgpRightRoundedLine,  scgpBottomRoundedLine]) then
  begin
    ...
    case FOptions.ShapeStyle of
      scgpLeftLineMargins:
        begin
          ...
          if FOptions.ShapeStyleLineSize > 0 then
            G.DrawLine(P, FrameR.X, (Height - FOptions.ShapeStyleLineSize) div 2, FrameR.X,
              (Height - FOptions.ShapeStyleLineSize) div 2 + FOptions.ShapeStyleLineSize)
          else
      ...
      scgpRightLineMargins:
        begin
          ...
          if FOptions.ShapeStyleLineSize > 0 then
            G.DrawLine(P,
              FrameR.X + FrameR.Width,
              (Height - FOptions.ShapeStyleLineSize) div 2,
              FrameR.X + FrameR.Width,
              (Height - FOptions.ShapeStyleLineSize) div 2 + FOptions.ShapeStyleLineSize)
          else
      ...
      scgpTopLineMargins:
        begin
          ...
          if FOptions.ShapeStyleLineSize > 0 then
            G.DrawLine(P,
            (Width - FOptions.ShapeStyleLineSize) div 2,
            FrameR.Y,
            (Width - FOptions.ShapeStyleLineSize) div 2 + FOptions.ShapeStyleLineSize,
            FrameR.Y)
          else
      ...
      scgpLeftRoundedLine, scgpTopRoundedLine, scgpRightRoundedLine,  scgpBottomRoundedLine:
        begin
          ...
          if (FrameColor <> 0) and (FOptions.FrameColorAlpha < 255) and
             (FOptions.ShapeStyle in [scgpRoundedRect, scgpRoundedLeftRight])
          then
          begin
          ...
          // frame
          if FOptions.ShapeStyle in [scgpRoundedRect, scgpRoundedLeftRight] then
          begin
            l := FrameR.X;
            t := FrameR.Y;
            w := FrameR.Width;
            h := FrameR.Height;
             if FOptions.ShapeStyle = scgpRoundedLeftRight
            then
              d := FrameR.Height
            else
              d := Options.ShapeCornerRadius * 2;
          ...
          begin
            case FOptions.ShapeStyle  of
              scgpLeftRoundedLine:
                if FOptions.ShapeStyleLineSize > 0 then
                  GPDrawHVRoundedLine(G, FOptions.FFrameWidth,
                    0,
                    (Height - FOptions.ShapeStyleLineSize) div 2,
                    0,
                    (Height - FOptions.ShapeStyleLineSize) div 2 + FOptions.ShapeStyleLineSize,
                  ...
                  GPDrawHVRoundedLine(G, FOptions.FFrameWidth,
                    0,
                    FOptions.ShapeCornerRadius,
                    0,
                    Height - FOptions.ShapeCornerRadius,
                    FrameColor);
              ...
              scgpTopRoundedLine:
                if FOptions.ShapeStyleLineSize > 0 then
                  ...
                  GPDrawHVRoundedLine(G, FOptions.FFrameWidth,
                    FOptions.ShapeCornerRadius,
                    0,
                    Width - FOptions.ShapeCornerRadius,
                    0,
                    FrameColor);

              scgpRightRoundedLine:
                if FOptions.ShapeStyleLineSize > 0 then
                  GPDrawHVRoundedLine(G, FOptions.FFrameWidth,
                    Width - FOptions.FFrameWidth,
                    (Height - FOptions.ShapeStyleLineSize) div 2,
                    Width - FOptions.FFrameWidth,
                    (Height - FOptions.ShapeStyleLineSize) div 2 + FOptions.ShapeStyleLineSize,
                    FrameColor)
                  ...
                  GPDrawHVRoundedLine(G, FOptions.FFrameWidth,
                    ...
                    FOptions.ShapeCornerRadius,
                    Width - FOptions.FFrameWidth,
                    Height - FOptions.ShapeCornerRadius, FrameColor);

              scgpBottomRoundedLine:
                if FOptions.ShapeStyleLineSize > 0 then
                  GPDrawHVRoundedLine(G, FOptions.FFrameWidth,
                    (Width - FOptions.ShapeStyleLineSize) div 2,
                    FrameR.Y + FrameR.Height - FOptions.FFrameWidth / 2,
                    (Width - FOptions.ShapeStyleLineSize) div 2 + FOptions.ShapeStyleLineSize,
                    FrameR.Y + FrameR.Height - FOptions.FFrameWidth / 2,
                    FrameColor);
                else
  ...
  if FDrawTextMode = scdtmGDIPlus then
      GPDrawImageAndText(G, ACanvas, R, XMargin, XSpacing,
        ...
        IsRightToLeft, False, FScaleFactor, WordWrap, False, CaptionCenterAlignment)
  else
  begin
    if GlowEffect.Enabled and GetGlowParams(ACtrlState, FGlowColor, FGlowSize, FGlowAlpha) then
    begin
      if ((Layout = blGlyphLeft) or (Layout = blGlyphRight)) and not CaptionCenterAlignment then
      begin
...
begin
  ...
  begin
    ...
    Self.FShapeCornerRadius := TscGPCheckBoxOptions(Source).FShapeCornerRadius;
...
procedure TscGPCheckBoxOptions.SetShapeCornerRadius(Value: Integer);
begin
  if (FShapeCornerRadius <> Value) and (Value >= 0) then
  begin
    FShapeCornerRadius := Value;
...
begin
  ...
  case FState of
    scsHot: Result := FCheckMarkHotColor;
    scsPressed: Result := FCheckMarkPressedColor;
    scsDisabled: Result := FCheckMarkDisabledColor;
  end;
  if FStyleColors then
    Result := GetStyleColor(Result{$IFDEF VER340_UP}, FControl{$ENDIF});
end;
...
begin
  ...
  FOptionsChecked.FShapeCornerRadius := MulDiv(FOptionsChecked.FShapeCornerRadius, M, D);
  if FScaleCheckMarkThickness then
...
begin
  ...
  if (ACtrlState = scsDisabled) and (FDisabledFontColor <> clNone) then
     ACanvas.Font.Color := GetStyleColor(FDisabledFontColor{$IFDEF VER340_UP}, Self{$ENDIF});
  ...
  try
    ...
    if FCurOptions.ShapeCornerRadius = 0 then
    begin
      G.FillRectangle(B, FillR);
      G.DrawRectangle(P, FrameR);
    end
    ...
    begin
      ...
      try
        ...
        if FrameColor <> 0 then
        begin
          d := FCurOptions.ShapeCornerRadius * 2 - FCurOptions.FrameWidth;
          if d < 1 then d := 1;
        end
        else
          d := FCurOptions.ShapeCornerRadius * 2;
...
procedure TscGPCheckBox.SetAlignment(Value: TLeftRight);
begin
...
procedure TscGPRadioButton.SetAlignment(Value: TLeftRight);
begin
  if FAlignment <> Value then
  begin
    FAlignment := Value;
...
procedure TscGPPanel.SetWordWrap(Value: Boolean);
begin
...
type
  THookControlClass = class(TControl);
...
begin
  ...
  if Assigned(THookControlClass(Control).OnCanResize) then
    THookControlClass(Control).OnCanResize(Self, W, H, LResize);
...
begin
  ...
  begin
    Result := GetStyleColor(clBtnText{$IFDEF VER340_UP}, Self{$ENDIF});
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      scDrawUtils.DrawFormBackground(ACanvas, Rect(0, 0, Width, Height){$IFDEF VER340_UP}, Self{$ENDIF});
  end;
end;
...
procedure TscGPSizeBox.Notification(AComponent: TComponent; Operation: TOperation);
begin
  inherited;
  if (Operation = opRemove) and (AComponent = FResizeTargetControl) then
    FResizeTargetControl := nil;
end;
...
begin
  ...
  if FResizeTargetControl = nil then
    FResizeTargetControl := GetParentForm(Self);

  if FResizeTargetControl <> nil then
    if not ((FResizeTargetControl is TCustomForm) and (TCustomForm(FResizeTargetControl).WindowState <> wsNormal)) then
    begin
      FDown := True;
...
begin
  inherited;
  if FDown and (FResizeTargetControl <> nil) then
  begin
    GetCursorPos(P);
    ...
    if (P1.X <> 0) or (P1.Y <> 0) then
      FResizeTargetControl.SetBounds(FResizeTargetControl.Left, FResizeTargetControl.Top, 
        FResizeTargetControl.Width + P1.X, FResizeTargetControl.Height + P1.Y);
  end;
end;
...
begin
  ...
  GR := RectToGPRect(R);
  GR.Width := GR.Height;
  C := ColorToGPCOlor(GetStyleColor(FGlyphColor{$IFDEF VER340_UP}, Self{$ENDIF}), FGlyphColorAlpha);
  G := TGPGraphics.Create(ACanvas.Handle);
  G.SetSmoothingMode(SmoothingModeHighQuality);
  try
...
begin
  ...
  if Enabled then
    ...
    ACanvas.Font.Color := GetGroupBoxTextColor(scsDisabled{$IFDEF VER340_UP}, Self{$ENDIF});
...
begin
  ...
  case FGlyphOptions.Kind of
    ...
    scgpbgkShutDown:
     ...
     scgpbgkMaximizeRounded:
       scGPUtils.GPDrawMaximizeRoundedGlyph(G, GlyphR, GlyphColor, GlyphScaleFactor, FGlyphOptions.Thickness);
     scgpbgkMaximize:
     begin
       if IsWindows11 then
         scGPUtils.GPDrawMaximizeRoundedGlyph(G, GlyphR, GlyphColor, GlyphScaleFactor, FGlyphOptions.Thickness)
     ...
     begin
       if IsWindows11 then
         scGPUtils.GPDrawRestoreRoundedGlyph(G, GlyphR, GlyphColor, GlyphScaleFactor, FGlyphOptions.Thickness)
       else
         scGPUtils.GPDrawRestoreGlyph(G, GlyphR, GlyphColor, GlyphScaleFactor, FGlyphOptions.Thickness);
     end;
     scgpbgkRestoreRounded:
       scGPUtils.GPDrawRestoreRoundedGlyph(G, GlyphR, GlyphColor, GlyphScaleFactor, FGlyphOptions.Thickness);
     scgpbgkFileNew:
  ...
  begin
    ...
    if ((FInternalLayout = blGlyphLeft) or (FInternalLayout = blGlyphRight)) and not CaptionCenterAlignment then
...
begin
  ...
  begin
    C := ColorToGPColor(GetStyleColor(FFillColor{$IFDEF VER340_UP}, Self{$ENDIF}), FFillColorAlpha);
    C2 := ColorToGPColor(GetStyleColor(FFillColor2{$IFDEF VER340_UP}, Self{$ENDIF}), FFillColor2Alpha);
    FR2 := FillR;
  ...
  if ACtrlState = scsNormal then
    ...
    ACanvas.Font.Color := GetCheckBoxTextColor(ACtrlState{$IFDEF VER340_UP}, Self{$ENDIF});
...
procedure TscGPToggleSwitch.SetFrameWidth(Value: Integer);
begin
  if (Value > 0) and (Value <> FFrameWidth) then
  begin
    FFrameWidth := Value;
...
procedure TscGPToggleSwitch.SetThumbMargin(Value: Integer);
begin
  if (FThumbMargin <> Value) and (Value >= 0) then
  begin
    FThumbMargin := Value;
...
procedure TscGPToggleSwitch.SetThumbMarginHot(Value: Integer);
begin
  if (FThumbMarginHot <> Value) and (Value >= 0) then
  begin
    FThumbMarginHot := Value;
...
procedure TscGPToggleSwitch.SetThumbMarginPressed(Value: Integer);
begin
  if (FThumbMarginPressed <> Value) and (Value >= 0) then
  begin
    FThumbMarginPressed := Value;
