...
function TscGPDBTrackBar.IsReadOnly: Boolean;
begin
...
function TscGPDBSlider.IsReadOnly: Boolean;
begin
  Result := inherited IsReadOnly;
  if not Result and (FDataLink <> nil) and FDataLink.CanModify then
    Result := not FDataLink.Edit;
...
function TscGPDBDial.IsReadOnly: Boolean;
begin
  Result := inherited IsReadOnly;
  if not Result and (FDataLink <> nil) and FDataLink.CanModify then
    Result := not FDataLink.Edit;
...
function TscGPDBGearDial.IsReadOnly: Boolean;
begin
  Result := inherited IsReadOnly;
  if not Result and (FDataLink <> nil) and FDataLink.CanModify then
    Result := not FDataLink.Edit;
...
function TscGPDBComboEdit.IsReadOnly: Boolean;
begin
  Result := ReadOnly;
  if not Result and (FDataLink <> nil) and FDataLink.CanModify then
    Result := not FDataLink.Edit;
...
function TscGPDBListBox.IsReadOnly: Boolean;
begin
  Result := ReadOnly;
  if not Result and (FDataLink <> nil) and FDataLink.CanModify then
    Result := not FDataLink.Edit;
...
function TscGPDBComboBox.IsReadOnly: Boolean;
begin
  Result := ReadOnly;
  if not Result and (FDataLink <> nil) and FDataLink.CanModify then
    Result := not FDataLink.Edit;
...
function TscGPDBSpinEdit.IsReadOnly: Boolean;
begin
  Result := ReadOnly;
  if not Result and (FDataLink <> nil) and FDataLink.CanModify then
    Result := not FDataLink.Edit;
