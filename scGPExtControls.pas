...
type
  ...
  published
    ...
    property FrameDisabledColor: TColor read FFrameDisabledColor write SetFrameDisabledColor;
    ...
    property CheckedNormalColor: TColor read FCheckedNormalColor write SetCheckedNormalColor;
    property CheckedDisabledColor: TColor read FCheckedDisabledColor write SetCheckedDisabledColor;
    ...
    property CheckedFrameNormalColor: TColor read FCheckedFrameNormalColor write SetCheckedFrameNormalColor;
    property CheckedFrameDisabledColor: TColor read FCheckedFrameDisabledColor write SetCheckedFrameDisabledColor;
    ...
    property CheckMarkNormalColor: TColor read FCheckMarkNormalColor write SetCheckMarkNormalColor;
    property CheckMarkDisabledColor: TColor read FCheckMarkDisabledColor write SetCheckMarkDisabledColor;
  ...
  protected
    ...
    function GetItemAlignmentFlags: Integer;
    procedure SetItemTextAlignment(const Value: TAlignment);
    ...
    property ItemTextAlignment : TAlignment
      read FItemTextAlignment write SetItemTextAlignment default taLeftJustify;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
  ...
  TscGPComboShapeStyle = (scgpcssRect, scgpcssRoundedRect, scgpcssRoundedLeftRight,
    scgpcssLine, scgpcssNone, scgpcssLineRect);
   ...
   TscGPComboOptions = class(TPersistent)
    ...
    published
      ...
      property FontDisabledColor: TColor read FFontDisabledColor write SetFontDisabledColor;
  ...
  protected
    ...
    function GetListBoxItemTextAlignment: TAlignment;
    procedure SetListBoxItemTextAlignment(Value: TAlignment);
  ...
  public
    ...
    property ListBoxItemTextAlignment: TAlignment
     read GetListBoxItemTextAlignment write SetListBoxItemTextAlignment;
  ...
  published
    ...
    property ListBoxItemTextAlignment;
   ...
   TscGPEditShapeStyle = (scgpessRect, scgpessRoundedRect, scgpessRoundedLeftRight,
    scgpessLine, scgpessNone, scgpessLineRect);
   ...
   TscGPEditOptions = class(TPersistent)
    private
      ...
      FFocusedLineWidth: Integer;

      procedure SetFocusedLineColor(Value: TColor);
      procedure SetFocusedLineWidth(Value: Integer);
    ...
    published
      ...
      property FocusedLineColor: TColor
        read FFocusedLineColor write SetFocusedLineColor;

      property FocusedLineWidth: Integer
        read FFocusedLineWidth write SetFocusedLineWidth;
  ...
  TscGPEditButtonKind =
    (scgpebCustom, scgpebDropDown, scgpebClear,
     ...
     scgpebRefresh, scgpebMic, scgpebPassword, scgpebFolder);
 ...
 published
  ...
  private
    ...
    procedure SetScrollButtonBGColor(Value: TColor);
  ...
  published
    ...
    property ScrollButtonBGColor: TColor
      read FScrollButtonBGColor write SetScrollButtonBGColor;
...
uses
  System.Math, Vcl.Consts, Vcl.Themes, Vcl.Buttons, Vcl.Clipbrd, System.MaskUtils;
...
begin
  ...
  begin
    C := ColorToGPColor(GetStyleColor(Options.FillColor{$IFDEF VER340_UP}, FControl{$ENDIF}), Options.FillColorAlpha);
    B.SetColor(C);
    G.FillRectangle(B, R);
  end;
  ...
  // draw thumb
  C := ColorToGPColor(GetStyleColor(Options.ThumbColor{$IFDEF VER340_UP}, FControl{$ENDIF}), Options.ThumbColorAlpha);
  case FThumbState of
    scsHot:
      C := ColorToGPColor(GetStyleColor(Options.ThumbColor{$IFDEF VER340_UP}, FControl{$ENDIF}), Options.ThumbColorHotAlpha);
    scsPressed:
      C := ColorToGPColor(GetStyleColor(Options.ThumbColor{$IFDEF VER340_UP}, FControl{$ENDIF}), Options.ThumbColorPressedAlpha);
  end;
  B.SetColor(C);
...
begin
  ...
  begin
    ...
    begin
      C := ColorToGPColor(GetStyleColor(FOptions.FFillColor{$IFDEF VER340_UP}, Self{$ENDIF}), FOptions.FFillColorAlpha);
      B := TGPSolidBrush.Create(C);
    end
    else
    begin
      Col := GetStyleColor(FOptions.FFillColor{$IFDEF VER340_UP}, Self{$ENDIF});
      C := ColorToGPColor(Col,FOptions.FFillColorAlpha);
      Col := GetStyleColor(FOptions.FFillColor2{$IFDEF VER340_UP}, Self{$ENDIF});
  ...
  try
    ...
    begin
      C := ColorToGPColor(GetStyleColor(FOptions.FFrameColor{$IFDEF VER340_UP}, Self{$ENDIF}), FOptions.FFrameColorAlpha);
      P.SetColor(C);
    ...
    then
    begin
      C := ColorToGPColor(GetStyleColor(FScrollBarOptions.FillColor{$IFDEF VER340_UP}, Self{$ENDIF}), FScrollBarOptions.FillColorAlpha);
...
begin
  if Focused then
    Result := GetStyleColor(FFocusedFontColor{$IFDEF VER340_UP}, FControl{$ENDIF})
  else
    Result := GetStyleColor(FFontColor{$IFDEF VER340_UP}, FControl{$ENDIF});
end;
...
begin
  ...
  begin
    ...
    FShapeCornerRadius := TscGPListCheckBoxOptions(Source).FShapeCornerRadius;
...
procedure TscGPListCheckBoxOptions.SetShapeCornerRadius(Value: Integer);
begin
...
begin
  ...
  begin
    if FState = scsDisabled then
      Result := FCheckedDisabledColor
    else
      Result := FCheckedNormalColor;
  end;
...
begin
  ...
  begin
    if FState = scsDisabled then
      Result := FCheckedFrameDisabledColor
    else
      Result := FCheckedFrameNormalColor;
  end;
  Result := GetStyleColor(Result{$IFDEF VER340_UP}, FControl{$ENDIF});
end;
...
begin
  if ListBox.ItemIndex > Count - 1 then
...
begin
  ...
  if ListBox.FItemIndex > Count - 1 then
    ListBox.FItemIndex := -1;
  ListBox.RePaintControl;
end;
...
begin
  ...
  {$IFDEF VER340_UP}
  FSelectionOptions.FControl := Self;
  {$ENDIF}
  ...
  {$IFDEF VER340_UP}
  FCheckBoxOptions.FControl := Self;
  {$ENDIF}
  ...
  FLineColorAlpha := 20;
  FItemTextAlignment := taLeftJustify;
end;

function TscGPCustomListBox.IsReadOnly: Boolean;
begin
  Result := False;
end;

procedure TscGPCustomListBox.SetItemTextAlignment(const Value: TAlignment);
begin
  if FItemTextAlignment <> Value then
  begin
    FItemTextAlignment := Value;
    RePaintControl;
  end;
end;

function TscGPCustomListBox.GetItemAlignmentFlags: Integer;
begin
  case FItemTextAlignment of
...
begin
  ...
  FCheckBoxOptions.FShapeCornerRadius := MulDiv(FCheckBoxOptions.FShapeCornerRadius, M, D);
...
begin
  ...
  begin
    ...
    HC := GetStyleColor(FHeaderOptions.Color{$IFDEF VER340_UP}, Self{$ENDIF});
  ...
  Cnvs.Font.Color := GetStyleColor(FHeaderFont.Color{$IFDEF VER340_UP}, Self{$ENDIF});
...
var
  ...
  P: TGPPen;
  W1: Integer;
  CheckPath, FillPath, FramePath: TGPGraphicsPath;
  l, t, w, h, d: Single;
  FillR, FrameR: TGPRectF;
begin
  W1 := FCheckBoxOptions.ShapeSize;
  CR := Rect(ARect.Left + ARect.Width div 2 - W1 div 2,
    ARect.Top + ARect.Height div 2 - W1 div 2,
    ARect.Left + ARect.Width div 2 - W1 div 2 + W1,
    ARect.Top + ARect.Height div 2 - W1 div 2 + W1);
  ...
  if CheckBoxOptions.ShapeCornerRadius = 0 then
    begin
      G.FillRectangle(B, FillR);
      G.DrawRectangle(P, FrameR);
    end
    ...
    begin
      ...
      try
        ...
        if FrameColor <> 0 then
        begin
          d := FCheckBoxOptions.ShapeCornerRadius * 2 - FCheckBoxOptions.FrameWidth;
          if d < 1 then d := 1;
        end
        else
          d := FCheckBoxOptions.ShapeCornerRadius * 2;

        FillPath.StartFigure;
        FillPath.AddArc(l, t, d, d, 180, 90);
        FillPath.AddArc(l + w - d, t, d, d, 270, 90);
        if d < FillR.Height then
          d := d + 1;
  ...
  if AChecked then
  begin
    W1 := FCheckBoxOptions.CheckMarkThickness;
    P.SetWidth(W1);
    P.SetColor(CheckColor);
    InflateGPRect(FrameR,
      -FCheckBoxOptions.FrameWidth / 2 - W1 / 2,
       -FCheckBoxOptions.FrameWidth / 2 - W1 / 2);
    FrameR.Y:= FrameR.Y - W1 / 2 - 1;
...
begin
  ...
  begin
    C := GetStyleColor(FItems[Index].FCustomColor{$IFDEF VER340_UP}, Self{$ENDIF});
  ...
  then
  begin
    C := GetStyleColor(FLineColor{$IFDEF VER340_UP}, Self{$ENDIF});
  ...
  begin
    ...
    if (FItems[Index].FCustomDetailTextColor <> clNone) and FItems[Index].Enabled and not FItems[Index].Active then
      C := GetStyleColor(Items[Index].FCustomDetailTextColor{$IFDEF VER340_UP}, Self{$ENDIF})
    else
    if not FItems[Index].Enabled then
    begin
      C := GetStyleColor(DetailFont.Color{$IFDEF VER340_UP}, Self{$ENDIF});
      if FDrawTextMode = scdtmGDI then
    ...
    begin
      if (FSelectionOptions.FFontColor = clHighLightText) and IsCustomStyle{$IFDEF VER340_UP}(Self){$ENDIF}
      then
        C := GetSelectionTextColor{$IFDEF VER340_UP}(Self){$ENDIF} // fix for some vcl styles
      else
        C := GetStyleColor(SelectionOptions.FontColor{$IFDEF VER340_UP}, Self{$ENDIF});
  ...
  // draw text
  Flags := GetItemAlignmentFlags or DT_NOPREFIX;
  ...
  if (FItems[Index].FCustomTextColor <> clNone) and FItems[Index].Enabled and not FItems[Index].Active then
    Cnvs.Font.Color := GetStyleColor(Items[Index].FCustomTextColor{$IFDEF VER340_UP}, Self{$ENDIF})
  else
  if not FItems[Index].Enabled then
  begin
    C := GetStyleColor(Self.Font.Color{$IFDEF VER340_UP}, Self{$ENDIF});
    if FDrawTextMode = scdtmGDI then
      if IsLightColor(C) then
        C := DarkerColor(C, 50)
      else
  ...
  begin
    if (FSelectionOptions.FFontColor = clHighLightText) and IsCustomStyle{$IFDEF VER340_UP}(Self){$ENDIF}
    then
      Cnvs.Font.Color := GetSelectionTextColor{$IFDEF VER340_UP}(Self){$ENDIF} // fix for some vcl styles
    else
      Cnvs.Font.Color := GetStyleColor(FSelectionOptions.FFontColor{$IFDEF VER340_UP}, Self{$ENDIF});
  end
  else
    Cnvs.Font.Color := GetStyleColor(Self.Font.Color{$IFDEF VER340_UP}, Self{$ENDIF});
...
begin
  ...
  begin
    if (FItemIndex <> I) and IsReadOnly then
      Exit;
...
begin
  ...
  if (I <> -1) and not (FItems[I].Header) and (Button = mbLeft) then
  begin
    if (ItemIndex <> I) and IsReadOnly then
      Exit;
    ItemIndex := I;
  end;
...
begin
  ...
  begin
    StopScrollTimer;
    I := ItemAtPos(X, Y);
    if (I <> -1) and not (FItems[I].Header) and (FMouseDown or (FMouseMoveChangeIndex and not IsScrollBarCaptured))
       and (I <> FMouseActive) then
    begin
      if (I <> FItemIndex) and IsReadOnly then
        Exit;
...
procedure TscGPPopupListBox.Reset;
begin
  SetItemActive(-1);
end;
...
begin
  Result := FFrameNormalColor;
  case FState of
    scsHot: Result := FFrameHotColor;
    scsPressed: Result := FFramePressedColor;
    scsFocused: Result := FFrameFocusedColor;
    scsDisabled: Result := FFrameDisabledColor;
  end;
  if FStyleColors then
    Result := GetStyleColor(Result{$IFDEF VER340_UP}, FControl{$ENDIF});
end;
...
begin
  ...
  case FState of
    scsHot: Result := FFontHotColor;
    scsPressed: Result := FFontPressedColor;
    scsFocused: Result := FFontFocusedColor;
    scsDisabled: Result := FFontDisabledColor;
  end;
  if FStyleColors then
    Result := GetStyleColor(Result{$IFDEF VER340_UP}, FControl{$ENDIF});
end;
...
function TscGPCustomComboBox.IsReadOnly: Boolean;
begin
  Result := False;
end;

procedure TscGPCustomComboBox.SetItemTextAlignment(const Value: TAlignment);
begin
  if FItemTextAlignment <> Value
  then
    begin
      FItemTextAlignment := Value;
      RePaintControl;
...
function TscGPCustomComboBox.GetItemAlignmentFlags: Integer;
begin
  case FItemTextAlignment of
    taCenter: Result := DT_CENTER;
    taRightJustify: Result := DT_RIGHT;
...
function TscGPCustomComboBox.GetListBoxItemTextAlignment: TAlignment;
begin
  Result := FListBox.ItemTextAlignment;
end;

procedure TscGPCustomComboBox.SetListBoxItemTextAlignment(Value: TAlignment);
begin
  FListBox.ItemTextAlignment := Value;
end;
...
begin
  ...
  begin
    ...
    begin
      ACanvas.Font := Self.Font;
      ACanvas.Font.Color := GetStyleColor(FOptions.FontColor{$IFDEF VER340_UP}, Self{$ENDIF});
  ...
  begin
    ...
    begin
      ...
      if (Images is TscCustomImageList) or (Images.ClassName = 'TVirtualImageList') then
  ...
  begin
    ...
    begin
      C := GetStyleColor(FOptions.FontColor{$IFDEF VER340_UP}, Self{$ENDIF});
      if FDrawTextMode = scdtmGDI then
        if IsLightColor(C) then
          C := DarkerColor(C, 40)
        else
  ...
  if (Items[Index].CustomTextColor <> clNone) and Items[Index].Enabled then
    ACanvas.Font.Color := GetStyleColor(Items[Index].FCustomTextColor{$IFDEF VER340_UP}, Self{$ENDIF})
  else
    ACanvas.Font.Color := GetStyleColor(FOptions.FontColor{$IFDEF VER340_UP}, Self{$ENDIF});
...
begin
  if FCheckIsReadOnly and (FOldItemIndex <> FListBox.ItemIndex) and IsReadOnly then
...
begin
  ...
  begin
    LIndex := FListBox.ItemIndex;
    if (FListBox.ItemIndex <> FOldItemIndex) and IsReadOnly then
      FListBox.ItemIndex := FOldItemIndex
    else
    begin
      if FListBox.ItemIndex <> LIndex then
        FListBox.ItemIndex := LIndex;
      RePaintControl;
...
begin
  ...
  begin
    ...
    FFocusedLineColor := TscGPEditOptions(Source).FFocusedLineColor;
    FFocusedLineWidth := TscGPEditOptions(Source).FFocusedLineWidth;
  end
  else
    inherited Assign(Source);
end;
...
procedure TscGPEditOptions.SetFocusedLineColor(Value: TColor);
begin
  if FFocusedLineColor <> Value then
  begin
...
procedure TscGPEditOptions.SetFocusedLineWidth(Value: Integer);
begin
  if (Value >= 0) and (FFocusedLineWidth <> Value) then
  begin
    FFocusedLineWidth := Value;
    Changed;
  end;
end;
...
begin
  ...
  case FState of
    scsHot: Result := FHotColor;
    scsPressed: Result := FFocusedColor;
    scsFocused: Result := FFocusedColor;
    scsDisabled: Result := FDisabledColor;
  end;
  if FStyleColors then
...
begin
  ...
  case FState of
    scsHot: Result := FFrameHotColor;
    scsPressed: Result := FFrameFocusedColor;
    scsFocused: Result := FFrameFocusedColor;
    scsDisabled: Result := FFrameDisabledColor;
  end;
  if FStyleColors then
...
begin
  ...
  case FState of
    scsHot: Result := FFontHotColor;
    scsPressed: Result := FFontFocusedColor;
    scsFocused: Result := FFontFocusedColor;
    scsDisabled: Result := FFontDisabledColor;
  end;
  if FStyleColors then
...
procedure TscGPCustomEdit.WMPaste(var Message: TWMPaste);
var
  S: String;
begin
...
begin
  ...
  begin
    FOptions.FFrameWidth := MulDiv(FOptions.FFrameWidth, M, D);
    FOptions.FFocusedLineWidth := MulDiv(FOptions.FFocusedLineWidth, M, D);
  end;
...
procedure TscGPCustomEdit.SetHideMaskWithEmptyText(Value: Boolean);
begin
...
function TscGPCustomEdit.IsEmptyTextWithMask: Boolean;
var
  I: Integer;
  S1, S2: String;
begin
...
begin
      ...
      // if X < AButton.ButtonRect.Left then X := AButton.ButtonRect.Left;
       ...
       begin
         if (FButtonImages is TscCustomImageList) or (FButtonImages.ClassName = 'TVirtualImageList') then
           FButtonImages.Draw(ACanvas, X, Y, I, False)
         else
  ...
  if AButton.Down then
    C := ColorToGPColor(GetStyleColor(AButton.GlyphColor{$IFDEF VER340_UP}, Self{$ENDIF}), AButton.GlyphColorPressedAlpha)
  else
  if AButton.MouseIn then
    C := ColorToGPColor(GetStyleColor(AButton.GlyphColor{$IFDEF VER340_UP}, Self{$ENDIF}), AButton.GlyphColorHotAlpha)
  else
  if AButton.Enabled and Self.Enabled then
    C := ColorToGPColor(GetStyleColor(AButton.GlyphColor{$IFDEF VER340_UP}, Self{$ENDIF}), AButton.GlyphColorAlpha)
  else
    C := ColorToGPColor(GetStyleColor(AButton.GlyphColor{$IFDEF VER340_UP}, Self{$ENDIF}), AButton.GlyphColorAlpha div 2);
  ...
  case AButton.Kind of
    ...
    scgpebPassword:
      GPDrawPasswordGlyph(G, R, C, FScaleFactor, T);
    scgpebFolder:
      GPDrawFolderGlyph(G, R, C, FScaleFactor, T);
  end;
end;
...
begin
  ...
  try
    ...
    if Focused and (Options.FocusedLineWidth > 0) then
    begin
      R1.X := 0;
      R1.Y := Height - Options.FocusedLineWidth;
      R1.Width := Width;
      R1.Height := Options.FocusedLineWidth;
      R2.X := 0;
      R2.Y := 0;
      R2.Width := Width;
      R2.Height := Height;
      LB := TGPSolidBrush.Create(ColorToGPColor(GetStyleColor(Options.FocusedLineColor{$IFDEF VER340_UP}, Self{$ENDIF}), 255));
      if Options.ShapeStyle in [scgpessRoundedLeftRight, scgpessRoundedRect] then
      begin
        G.SetClip(R1);
        if Options.ShapeStyle = scgpessRoundedLeftRight then
          GPFillRoundedRect(G, R2, LB, 0)
        else
          GPFillRoundedRect(G, R2, LB, Options.ShapeCornerRadius);
        G.ResetClip;
      end
      else
        G.FillRectangle(LB, R1);
      LB.Free;
    end;
...
procedure TscGPCustomEdit.WMCHECKPARENTBG(var Message: TMessage);
begin
  FStopGetParentBG := False;
  DoPaint;
end;
...
function TscGPComboEdit.IsReadOnly: Boolean;
begin
  Result := ReadOnly;
end;
...
begin
  if FCheckIsReadOnly and (FListBox.ItemIndex <> Value) and IsReadOnly then
    FOldItemIndex := FListBox.ItemIndex
  else
  begin
    FListBox.ItemIndex := Value;
  ...
  begin
    ...
    begin
      if FCheckIsReadOnly and (Text <> FListBox.Items[FListBox.ItemIndex].Caption) and IsReadOnly then
        Exit;
...
begin
  ...
  FListBox.StopScrollTimer;
  FListBox.Hide;
  if (FListBox.ItemIndex >= 0) and not IsReadOnly and
...
begin
  ...
  begin
    if Text <> '' then
      FListBox.FItemIndex := FListBox.IndexOfCaption(Text, False)
    else
...
function TscGPSpinEdit.IsReadOnly: Boolean;
begin
  Result := ReadOnly;
end;
...
begin
  ...
  if FPasswordButton.Down then
    C := ColorToGPColor(GetStyleColor(FPasswordButton.GlyphColor{$IFDEF VER340_UP}, Self{$ENDIF}), FPasswordButton.GlyphColorPressedAlpha)
  else
  if FPasswordButton.MouseIn then
    C := ColorToGPColor(GetStyleColor(FPasswordButton.GlyphColor{$IFDEF VER340_UP}, Self{$ENDIF}), FPasswordButton.GlyphColorHotAlpha)
  else
  if Self.Enabled then
    C := ColorToGPColor(GetStyleColor(FPasswordButton.GlyphColor{$IFDEF VER340_UP}, Self{$ENDIF}), FPasswordButton.GlyphColorAlpha)
  else
    C := ColorToGPColor(GetStyleColor(FPasswordButton.GlyphColor{$IFDEF VER340_UP}, Self{$ENDIF}), FPasswordButton.GlyphColorAlpha div 2);
...
begin
  ...
  begin
    if Enabled then
      C := ColorToGPColor(ColorToRGB(GetStyleColor(Self.Font.Color{$IFDEF VER340_UP}, Self{$ENDIF})), 255)
    else  
      C := ColorToGPColor(ColorToRGB(GetStyleColor(Self.Font.Color{$IFDEF VER340_UP}, Self{$ENDIF})), 150);
  end
  else
  begin
...
var
  ...
  W: Integer;
begin
  Col := ColorToGPColor(GetStyleCOlor(clHighLight{$IFDEF VER340_UP}, Self{$ENDIF}), 200);
  G.SetSmoothingMode(SmoothingModeHighQuality);
  G.SetPixelOffsetMode(PixelOffsetModeHalf);
  ...
  C.Font.Color := GetStyleColor(clHighLightText{$IFDEF VER340_UP}, Self{$ENDIF});
end;
...
begin
  ...
  GFont := nil;
  Cnvs.Brush.Style := bsClear;
  CalFontColor := GetStyleColor(Self.Font.Color{$IFDEF VER340_UP}, Self{$ENDIF});
  ...
  begin
    ...
    then
      begin
        ...
        S := DateToStr(Now);
        if FInTodayR then
          Font.Color := scDrawUtils.GetActiveTextColor{$IFDEF VER340_UP}(Self){$ENDIF}
        else
          Font.Color := CalFontColor;
        if (FDrawTextMode  = scdtmGDIPlus) and (GFont <> nil) then
...
procedure TscGPMemo.SetPromptText(Value: String);
begin
  if FPromptText <> Value then
  begin
    FPromptText := Value;
...
procedure TscGPMemo.SetPromptTextColor(Value: TColor);
begin
  if FPromptTextColor <> Value then
  begin
    FPromptTextColor := Value;
...
procedure TscGPMemo.DrawPromptText(ACanvas: TCanvas);
var
  R: TRect;
  C: TColor;
begin
...
begin
  ...
  try
    ...
    then
    begin
      C1 := ColorToGPColor(GetStyleColor(FScrollBarOptions.FillColor{$IFDEF VER340_UP}, Self{$ENDIF}),
...
procedure TscGPMemo.WMCHECKPARENTBG(var Message: TMessage);
begin
  if FTransparent then
  begin
    FStopGetParentBG := False;
...
begin
  ...
  R.Height := Height;
  if Enabled then
    GlyphColor := ColorToGPColor(GetStyleColor(FGlyphColor{$IFDEF VER340_UP}, Self{$ENDIF}), FGlyphColorAlpha)
  else
    GlyphColor := ColorToGPColor(GetStyleColor(FGlyphColor{$IFDEF VER340_UP}, Self{$ENDIF}), FGlyphColorAlpha div 2);
  case FKind of
    scgpgkOneGear:
      begin
...
begin
  ...
  FScrollButtonBGColor := clBtnFace;
...
procedure TscGPScrollPanel.SetScrollButtonArrowColor(Value: TColor);
begin
...
procedure TscGPScrollPanel.SetScrollButtonColor(Value: TColor);
begin
...
procedure TscGPScrollPanel.SetScrollButtonBGColor(Value: TColor);
begin
   if FScrollButtonBGColor <> Value then
  begin
    FScrollButtonBGColor := Value;
    UpdateNC;
  end;
end;
...
procedure TscGPScrollPanel.WMMOUSEWHEEL(var Message: TWMMOUSEWHEEL);
begin
  if FMouseWheelSupport and FCanScroll and Buttons[0].Visible then
  begin
...
begin
  ...
  begin
    ...
    begin
      C := ColorToGPColor(GetStyleColor(FFillColor{$IFDEF VER340_UP}, Self{$ENDIF}), FFillColorAlpha);
      B := TGPSolidBrush.Create(C);
    end
    else
    begin
      Col := GetStyleColor(FFillColor{$IFDEF VER340_UP}, Self{$ENDIF});
      C := ColorToGPColor(LighterColor(Col, FFillGradientBeginColorOffset),
        FFillGradientBeginAlpha);
      if FFillColor2 <> clNone then
         Col := GetStyleColor(FFillColor2{$IFDEF VER340_UP}, Self{$ENDIF});
...
procedure TscGPScrollPanel.WMCHECKPARENTBG(var Message: TMessage);
begin
  inherited;
  if (FBGStyleKind = scgspbTransparent) and FCanScroll and Buttons[0].Visible then
...
begin
  ...
  begin
    GetScrollInfo;
    if (FBGStyleKind = scgspbTransparent) and Buttons[0].Visible then
      PostMessage(Handle, WM_CHECKPARENTBG, 0, 0);
  end;
end;
...
begin
  ...
  case Message.Msg of
    CM_STYLECHANGED:
      if (Self.BGStyleKind = scgspbTransparent) and FCanScroll and Buttons[0].Visible then
        PostMessage(Handle, WM_CHECKPARENTBG, 0, 0);
   end;
end;
...
begin
  ...
  LTransparent := (FBGStyleKind = scgspbTransparent) and (ParentBGBuffer <> nil);
  ...
  BC := ColorToGPColor(GetStyleColor(FScrollButtonColor{$IFDEF VER340_UP}, Self{$ENDIF}), BCAlpha);
  GC := ColorToGPColor(GetStyleColor(FScrollButtonArrowColor{$IFDEF VER340_UP}, Self{$ENDIF}), GCAlpha);
  B := TBitmap.Create;
  ...
  if LTransparent then
    B.Canvas.CopyRect(R, ParentBGBuffer.Canvas, Buttons[i].Rect);
  ...
  if LTransparent then
  begin
    GPBrush := TGPSolidBrush.Create(ColorToGPColor(GetStyleColor(FFillColor{$IFDEF VER340_UP}, Self{$ENDIF}), FFillColorAlpha));
    G.FillRectangle(GPBrush, R1);
    GPBrush.Free;
  end
  else
  begin
    GPBrush := TGPSolidBrush.Create(ColorToGPColor(GetStyleColor(FScrollButtonBGColor{$IFDEF VER340_UP}, Self{$ENDIF}), 255));
    G.FillRectangle(GPBrush, R1);
    GPBrush.Free;
  end;
