...
begin
  ...
  try
    // draw fill
    XFrameColor := ColorToGPColor(GetStyleColor(FFrameColor{$IFDEF VER340_UP}, Self{$ENDIF}), 255);
    XFillColor := ColorToGPColor(GetStyleColor(FFillColor{$IFDEF VER340_UP}, Self{$ENDIF}), FFillColorAlpha);
    ...
    if FFillStyle = scgpsfGradient then
    begin
      C1 := ColorToGPColor(LighterColor(GetStyleColor(FFillColor{$IFDEF VER340_UP}, Self{$ENDIF}), 50), FFillColorAlpha);
      C2 := ColorToGPColor(DarkerColor(GetStyleColor(FFillColor{$IFDEF VER340_UP}, Self{$ENDIF}), 50), FFillColorAlpha);
      R1 := FillR;
    ...
    begin
      ...
      begin
        ...
        if SMax > FMaxValue then
          SMax := FMaxValue;
        P.SetColor(ColorToGPColor(GetStyleColor(FScaleSections[I].Color{$IFDEF VER340_UP}, Self{$ENDIF}), FScaleSections[I].ColorAlpha));
    ...
    // draw scale ticks
    GColor := ColorToGPColor(GetStyleColor(FTicksColor{$IFDEF VER340_UP}, Self{$ENDIF}), FTicksColorAlpha);
    SubGColor := ColorToGPColor(GetStyleColor(FTicksColor{$IFDEF VER340_UP}, Self{$ENDIF}), FTicksColorAlpha div 2);
    P.SetColor(GColor);
    ...
    B.SetColor(ColorToGPColor(GetStyleColor(clWindowText{$IFDEF VER340_UP}, Self{$ENDIF}), 200));
    ...
    begin
      ...
      ACanvas.Font.Color := GetStyleColor(FValueTextColor{$IFDEF VER340_UP}, Self{$ENDIF});
    ...
    begin
      ...
      ACanvas.Font.Color := GetStyleColor(FValueHintColor{$IFDEF VER340_UP}, Self{$ENDIF});
      TW := ACanvas.TextWidth(S);
      TH := ACanvas.TextHeight(S);
      if FDrawTextMode = scdtmGDIPlus then
      begin
    ...
    // draw arrow
    A := FArrowColorAlpha;
    C := GetStyleColor(FArrowColor{$IFDEF VER340_UP}, Self{$ENDIF});
    ...
    C := GetStyleColor(FCenterFrameColor{$IFDEF VER340_UP}, Self{$ENDIF});
    ...
    begin
      ...
      C := GetStyleColor(FCenterFillColor{$IFDEF VER340_UP}, Self{$ENDIF});
...
function TscGPDial.IsReadOnly: Boolean;
begin
  Result := False;
end;
...
begin
  ...
  try
    ...
    if FFillStyle = scgpsfGradient then
    begin
      C1 := ColorToGPColor(LighterColor(GetStyleColor(FFillColor{$IFDEF VER340_UP}, Self{$ENDIF}), 30), FFillColorAlpha);
      C2 := ColorToGPColor(DarkerColor(GetStyleColor(FFillColor{$IFDEF VER340_UP}, Self{$ENDIF}), 30), FFillColorAlpha);
      R1 := FillR;
      InflateGPRect(R1, 1, 1);
    ...
    GP1 := GPRotate(GP1, CenterP, 45 + AngleOffset, True);
    A := FKnobColorAlpha;
    C := GetStyleColor(FKnobColor{$IFDEF VER340_UP}, Self{$ENDIF});
    ...
    begin
      ...
      SMax := FValue;
      P.SetWidth(SW);
      P.SetColor(ColorToGPColor(GetStyleColor(FProgressColor{$IFDEF VER340_UP}, Self{$ENDIF}), FProgressColorAlpha));
      AngleOffset := 270 * ((SMin - FMinValue) / (FMaxValue - FMinValue));
      StepAngle := 270 * ((SMax - FMinValue) / (FMaxValue - FMinValue));
      SubStepAngle := StepAngle - AngleOffset;
      AngleOffset := AngleOffset + 135;
    ...
    begin
      InflateRect(R, 3, 3);
      ACanvas.Font.Color := GetStyleColor(clBtnText{$IFDEF VER340_UP}, Self{$ENDIF});
      if FDrawTextMode = scdtmGDIPlus then
      begin
        R1 := RectToGPRect(R);
...
function TscGPGearDial.IsReadOnly: Boolean;
begin
  Result := False;
end;
...
begin
  ...
  try
    ...
    GColor := ColorToGPColor(GetStyleColor(FArrowHourColor{$IFDEF VER340_UP}, Self{$ENDIF}), FArrowHourColorAlpha);
    GP1 := CenterP;
    GP1.Y := GP1.Y - CenterRadius + FCenterFrameWidth / 2;
    GP2 := GP1;
    GP2.Y := GP1.Y - ArrowSize;
    ...
    GColor := ColorToGPColor(GetStyleColor(FArrowMinColor{$IFDEF VER340_UP}, Self{$ENDIF}), FArrowMinColorAlpha);
    GP1 := CenterP;
    GP1.Y := GP1.Y - CenterRadius + FCenterFrameWidth / 2;
    GP2 := GP1;
    GP2.Y := GP1.Y - ArrowSize;
    ...
    G.DrawLine(P, GP1.X, GP1.Y, GP2.X, GP2.Y);
    // draw center
    XFrameColor := ColorToGPColor(GetStyleColor(FCenterFrameColor{$IFDEF VER340_UP}, Self{$ENDIF}), FCenterFrameColorAlpha);
    XFillColor := ColorToGPColor(GetStyleColor(FCenterFillColor{$IFDEF VER340_UP}, Self{$ENDIF}), FCenterFillColorAlpha);
    P.SetColor(XFrameColor);
    P.SetWidth(FCenterFrameWidth);
    FillR := CenterR;
    FrameR := CenterR;
    ...
    if FCenterFillStyle = scgpsfGradient then
    begin
      C1 := ColorToGPColor(LighterColor(GetStyleColor(FCenterFillColor{$IFDEF VER340_UP}, Self{$ENDIF}), 20), FCenterFillColorAlpha);
      C2 := ColorToGPColor(DarkerColor(GetStyleColor(FCenterFillColor{$IFDEF VER340_UP}, Self{$ENDIF}), 20), FCenterFillColorAlpha);
      R1 := FillR;
      InflateGPRect(R1, 1, 1);
      GB := TGPLinearGradientBrush.Create(R1, C1, C2, FCenterFillGradientAngle);
      try
    ...
    GColor := ColorToGPColor(GetStyleColor(FArrowSecColor{$IFDEF VER340_UP}, Self{$ENDIF}), FArrowSecColorAlpha);
    GP1 := CenterP;
...
begin
 ...
 if FScalePosition = scgpspBeforeTrack then
  ...
  FColor := ColorToGPColor(GetStyleColor(FTrackColor{$IFDEF VER340_UP}, Self{$ENDIF}), FTrackColorAlpha);
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if SMax > FMaxValue then
          SMax := FMaxValue;
        FColor := ColorToGPColor(GetStyleColor(FScaleSections[I].Color{$IFDEF VER340_UP}, Self{$ENDIF}), FScaleSections[I].ColorAlpha);
        SectionR := TrackR;
    ...
    // draw ticks
    FColor := ColorToGPColor(GetStyleColor(FTicksColor{$IFDEF VER340_UP}, Self{$ENDIF}), FTicksColorAlpha);
    FColor2 := ColorToGPColor(GetStyleColor(FTicksColor{$IFDEF VER340_UP}, Self{$ENDIF}), FTicksColorAlpha div 2);
    P.SetColor(FColor);
    ...
    begin
      C := GetStyleColor(FTrackProgressColor{$IFDEF VER340_UP}, Self{$ENDIF});
...
function TscGPSlider.IsReadOnly: Boolean;
begin
  Result := False;
end;
    ...
    begin
     ...
     // fill shape
      if Self.Enabled then
        C := GetStyleColor(FThumbColor{$IFDEF VER340_UP}, Self{$ENDIF})
      else
        C := GetStyleColor(FThumbDisabledColor{$IFDEF VER340_UP}, Self{$ENDIF});
      A := 255;
