      ...
      begin
        ...
        begin
          ...
          begin
            ...
            then
            begin
              if IsCustomStyle{$IFDEF VER340_UP}(Self){$ENDIF} and IsDarkStyle{$IFDEF VER340_UP}(Self){$ENDIF} then
                ACanvas.Font.Color := GetStyleColor(ACanvas.Font.Color{$IFDEF VER340_UP}, Self{$ENDIF})
              else
                ACanvas.Font.Color := GetActiveTextColor{$IFDEF VER340_UP}(Self){$ENDIF}
            end
            else
            begin
              if IsCustomStyle{$IFDEF VER340_UP}(Self){$ENDIF} and IsDarkStyle{$IFDEF VER340_UP}(Self){$ENDIF} then
